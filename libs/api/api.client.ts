...
export interface IProtectedClient {
     ...
     */
    integrationsVKGetAuthLink(input: Empty, options?: RpcOptions): UnaryCall<Empty, GetAuthLink$2>;
    /**
     * @generated from protobuf rpc: IntegrationsVKGetData(google.protobuf.Empty) returns (messages.integrations_vk.GetDataResponse);
     */
    integrationsVKGetData(input: Empty, options?: RpcOptions): UnaryCall<Empty, GetDataResponse$2>;
    /**
     ...
     */
    integrationsVKPostCode(input: PostCodeRequest$2, options?: RpcOptions): UnaryCall<PostCodeRequest$2, Empty>;
    /**
