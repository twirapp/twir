...
export function newBus(nc: NatsConnection) {
	return {
		Events: {
			...
			KeywordMatched: new Queue<Events.KeywordMatchedMessage, any>(
				nc,
				Events.KeywordMatchedSubject
			),
			GreetingSended: new Queue<Events.GreetingSendedMessage, any>(
				nc,
			...
			PredictionBegin: new Queue<Events.PredictionBeginMessage, any>(
				nc,
				Events.PredictionBeginSubject
			),
			PredictionProgress: new Queue<Events.PredictionProgressMessage, any>(
				nc,
				Events.PredictionProgressSubject
			),
			PredictionLock: new Queue<Events.PredictionLockMessage, any>(
				nc,
				Events.PredictionLockSubject
			),
			PredictionEnd: new Queue<Events.PredictionEndMessage, any>(nc, Events.PredictionEndSubject),
			StreamFirstUserJoin: new Queue<Events.StreamFirstUserJoinMessage, any>(
				nc,
				Events.StreamFirstUserJoinSubject
			),
			ChannelBan: new Queue<Events.ChannelBanMessage, any>(nc, Events.ChannelBanSubject),
			ChannelUnbanRequestCreate: new Queue<Events.ChannelUnbanRequestCreateMessage, any>(
				nc,
				Events.ChannelUnbanRequestCreateSubject
			),
			ChannelUnbanRequestResolve: new Queue<Events.ChannelUnbanRequestResolveMessage, any>(
				nc,
				Events.ChannelUnbanRequestResolveSubject
			),
			ChannelMessageDelete: new Queue<Events.ChannelMessageDeleteMessage, any>(
				nc,
			...
			ModeratorAdded: new Queue<Events.ModeratorAddedMessage, any>(
				nc,
				Events.ModeratorAddedSubject
			),
			ModeratorRemoved: new Queue<Events.ModeratorRemovedMessage, any>(
				nc,
