...
export class migrateToTypeorm1663337758845 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "channels_commands" DROP CONSTRAINT "channels_commands_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_customvars" DROP CONSTRAINT "channels_customvars_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_dota_accounts" DROP CONSTRAINT "channels_dota_accounts_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_greetings" DROP CONSTRAINT "channels_greetings_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" DROP CONSTRAINT "channels_integrations_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" DROP CONSTRAINT "channels_integrations_integrationId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_keywords" DROP CONSTRAINT "channels_keywords_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_moderation_settings" DROP CONSTRAINT "channels_moderation_settings_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_permits" DROP CONSTRAINT "channels_permits_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_permits" DROP CONSTRAINT "channels_permits_userId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_timers" DROP CONSTRAINT "channels_timers_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_commands_responses" DROP CONSTRAINT "channels_commands_responses_commandId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" DROP CONSTRAINT "channels_commands_usages_userId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" DROP CONSTRAINT "channels_commands_usages_commandId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_dashboard_access" DROP CONSTRAINT "channels_dashboard_access_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "channels_dashboard_access" DROP CONSTRAINT "channels_dashboard_access_userId_fkey"`);
        await queryRunner.query(`ALTER TABLE "dota_matches" DROP CONSTRAINT "dota_matches_gameModeId_fkey"`);
        await queryRunner.query(`ALTER TABLE "dota_matches_cards" DROP CONSTRAINT "dota_matches_cards_match_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "dota_matches_results" DROP CONSTRAINT "dota_matches_results_match_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "notifications_userId_fkey"`);
        await queryRunner.query(`ALTER TABLE "notifications_messages" DROP CONSTRAINT "notifications_messages_notificationId_fkey"`);
        ...
        await queryRunner.query(`ALTER TABLE "users_stats" DROP CONSTRAINT "users_stats_channelId_fkey"`);
        await queryRunner.query(`ALTER TABLE "users_stats" DROP CONSTRAINT "users_stats_userId_fkey"`);
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" DROP CONSTRAINT "users_viewed_notifications_notificationId_fkey"`);
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" DROP CONSTRAINT "users_viewed_notifications_userId_fkey"`);
        ...
        await queryRunner.query(`ALTER TABLE "bots" ALTER COLUMN "type" TYPE "public"."bots_type_enum" USING "type"::"text"::"public"."bots_type_enum"`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "cooldownType" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "cooldownType" TYPE "public"."channels_commands_cooldowntype_enum" USING "cooldownType"::"text"::"public"."channels_commands_cooldowntype_enum"`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "cooldownType" SET DEFAULT 'GLOBAL'`);
        await queryRunner.query(`DROP TYPE "public"."CooldownType_old"`);
        await queryRunner.query(`ALTER TYPE "public"."CommandPermission" RENAME TO "CommandPermission_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "permission" TYPE "public"."channels_commands_permission_enum" USING "permission"::"text"::"public"."channels_commands_permission_enum"`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_customvars" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_greetings" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        await queryRunner.query(`ALTER TABLE "channels_greetings" ALTER COLUMN "channelId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" ALTER COLUMN "channelId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" ALTER COLUMN "integrationId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "channels_keywords" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        await queryRunner.query(`DROP INDEX "public"."channels_moderation_settings_channelId_type_key"`);
        await queryRunner.query(`ALTER TABLE "channels_moderation_settings" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        await queryRunner.query(`ALTER TYPE "public"."SettingsType" RENAME TO "SettingsType_old"`);
        await queryRunner.query(`CREATE TYPE "public"."channels_moderation_settings_type_enum" AS ENUM('links', 'blacklistsb', 'symbols', 'longMessage', 'caps', 'emotes')`);
        await queryRunner.query(`ALTER TABLE "channels_moderation_settings" ALTER COLUMN "type" TYPE "public"."channels_moderation_settings_type_enum" USING "type"::"text"::"public"."channels_moderation_settings_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."SettingsType_old"`);
        await queryRunner.query(`ALTER TABLE "channels_permits" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_timers" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        await queryRunner.query(`ALTER TABLE "channels_timers" ALTER COLUMN "enabled" SET DEFAULT false`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_commands_responses" ALTER COLUMN "commandId" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" ALTER COLUMN "commandId" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "dota_matches" ADD CONSTRAINT "UQ_27d39ee5a1cdb04ed78a52286a1" UNIQUE ("match_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "dota_matches_results" ADD CONSTRAINT "UQ_66717d38c93b88a283ad77736ad" UNIQUE ("match_id")`);
        await queryRunner.query(`ALTER TABLE "integrations" ALTER COLUMN "id" SET DEFAULT 'gen_random_uuid()'`);
        await queryRunner.query(`ALTER TYPE "public"."IntegrationService" RENAME TO "IntegrationService_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "notifications_messages" ALTER COLUMN "langCode" TYPE "public"."notifications_messages_langcode_enum" USING "langCode"::"text"::"public"."notifications_messages_langcode_enum"`);
        ...
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" ALTER COLUMN "createdAt" TYPE TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" ALTER COLUMN "createdAt" SET DEFAULT now()`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e32891d3f8e343fe1d0107fa4e" ON "dota_medals" ("name") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" ALTER COLUMN "createdAt" SET DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" ALTER COLUMN "createdAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "users_stats" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "users_files" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_d98a275f8bc6cd986fcbe2eab01"`);
        await queryRunner.query(`ALTER TABLE "tokens" ALTER COLUMN "obtainmentTimestamp" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "tokens" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        ...
        await queryRunner.query(`ALTER TABLE "notifications_messages" ALTER COLUMN "langCode" TYPE "public"."LangCode_old" USING "langCode"::"text"::"public"."LangCode_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "notifications" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`CREATE TYPE "public"."IntegrationService_old" AS ENUM('LASTFM', 'VK', 'FACEIT', 'SPOTIFY', 'DONATIONALERTS')`);
        await queryRunner.query(`ALTER TABLE "integrations" ALTER COLUMN "service" TYPE "public"."IntegrationService_old" USING "service"::"text"::"public"."IntegrationService_old"`);
        await queryRunner.query(`DROP TYPE "public"."integrations_service_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."IntegrationService_old" RENAME TO "IntegrationService"`);
        await queryRunner.query(`ALTER TABLE "integrations" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "dota_matches_results" DROP CONSTRAINT "UQ_66717d38c93b88a283ad77736ad"`);
        await queryRunner.query(`ALTER TABLE "dota_matches_results" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "dota_matches_cards" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "dota_matches" ALTER COLUMN "gameModeId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "dota_matches" DROP CONSTRAINT "UQ_27d39ee5a1cdb04ed78a52286a1"`);
        await queryRunner.query(`ALTER TABLE "dota_matches" ALTER COLUMN "startedAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "dota_matches" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" ALTER COLUMN "commandId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "channels_commands_responses" ALTER COLUMN "commandId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "channels_commands_responses" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "channels_timers" ALTER COLUMN "channelId" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "channels_timers" ALTER COLUMN "enabled" SET DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "channels_timers" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_permits" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`CREATE TYPE "public"."SettingsType_old" AS ENUM('links', 'blacklists', 'symbols', 'longMessage', 'caps', 'emotes')`);
        await queryRunner.query(`ALTER TABLE "channels_moderation_settings" ALTER COLUMN "type" TYPE "public"."SettingsType_old" USING "type"::"text"::"public"."SettingsType_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_moderation_settings" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`CREATE UNIQUE INDEX "channels_moderation_settings_channelId_type_key" ON "channels_moderation_settings" ("type", "channelId") `);
        await queryRunner.query(`ALTER TABLE "channels_keywords" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" ALTER COLUMN "integrationId" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_customvars" ALTER COLUMN "type" TYPE "public"."CustomVarType_old" USING "type"::"text"::"public"."CustomVarType_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "channels_customvars" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
        await queryRunner.query(`CREATE TYPE "public"."CommandModule_old" AS ENUM('CUSTOM', 'DOTA', 'CHANNEL', 'MODERATION')`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "module" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "module" TYPE "public"."CommandModule_old" USING "module"::"text"::"public"."CommandModule_old"`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "module" SET DEFAULT 'CUSTOM'`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."CommandPermission_old" AS ENUM('BROADCASTER', 'MODERATOR', 'SUBSCRIBER', 'VIP', 'VIEWER', 'FOLLOWER')`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "permission" TYPE "public"."CommandPermission_old" USING "permission"::"text"::"public"."CommandPermission_old"`);
        await queryRunner.query(`DROP TYPE "public"."channels_commands_permission_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."CommandPermission_old" RENAME TO "CommandPermission"`);
        await queryRunner.query(`CREATE TYPE "public"."CooldownType_old" AS ENUM('GLOBAL', 'PER_USER')`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "cooldownType" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "cooldownType" TYPE "public"."CooldownType_old" USING "cooldownType"::"text"::"public"."CooldownType_old"`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "cooldownType" SET DEFAULT 'GLOBAL'`);
        ...
        await queryRunner.query(`ALTER TABLE "bots" ALTER COLUMN "type" TYPE "public"."BotType_old" USING "type"::"text"::"public"."BotType_old"`);
        ...
        await queryRunner.query(`CREATE INDEX "dota_medals_rank_tier_idx" ON "dota_medals" ("rank_tier") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "dota_matches_match_id_key" ON "dota_matches" ("match_id") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "dota_heroes_id_key" ON "dota_heroes" ("id") `);
        await queryRunner.query(`CREATE INDEX "channels_dota_accounts_id_idx" ON "channels_dota_accounts" ("id") `);
        await queryRunner.query(`CREATE INDEX "channels_commands_name_idx" ON "channels_commands" ("name") `);
        await queryRunner.query(`CREATE INDEX "channels_commands_channelId_idx" ON "channels_commands" ("channelId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "bots_tokenId_key" ON "bots" ("tokenId") `);
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" ADD CONSTRAINT "users_viewed_notifications_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users_viewed_notifications" ADD CONSTRAINT "users_viewed_notifications_notificationId_fkey" FOREIGN KEY ("notificationId") REFERENCES "notifications"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users_stats" ADD CONSTRAINT "users_stats_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users_stats" ADD CONSTRAINT "users_stats_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users_files" ADD CONSTRAINT "users_files_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "users_tokenId_fkey" FOREIGN KEY ("tokenId") REFERENCES "tokens"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "notifications_messages" ADD CONSTRAINT "notifications_messages_notificationId_fkey" FOREIGN KEY ("notificationId") REFERENCES "notifications"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "notifications" ADD CONSTRAINT "notifications_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "dota_matches_results" ADD CONSTRAINT "dota_matches_results_match_id_fkey" FOREIGN KEY ("match_id") REFERENCES "dota_matches"("match_id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "dota_matches_cards" ADD CONSTRAINT "dota_matches_cards_match_id_fkey" FOREIGN KEY ("match_id") REFERENCES "dota_matches"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "dota_matches" ADD CONSTRAINT "dota_matches_gameModeId_fkey" FOREIGN KEY ("gameModeId") REFERENCES "dota_game_modes"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_dashboard_access" ADD CONSTRAINT "channels_dashboard_access_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_dashboard_access" ADD CONSTRAINT "channels_dashboard_access_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" ADD CONSTRAINT "channels_commands_usages_commandId_fkey" FOREIGN KEY ("commandId") REFERENCES "channels_commands"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_commands_usages" ADD CONSTRAINT "channels_commands_usages_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_commands_responses" ADD CONSTRAINT "channels_commands_responses_commandId_fkey" FOREIGN KEY ("commandId") REFERENCES "channels_commands"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_timers" ADD CONSTRAINT "channels_timers_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_permits" ADD CONSTRAINT "channels_permits_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_permits" ADD CONSTRAINT "channels_permits_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_moderation_settings" ADD CONSTRAINT "channels_moderation_settings_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_keywords" ADD CONSTRAINT "channels_keywords_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" ADD CONSTRAINT "channels_integrations_integrationId_fkey" FOREIGN KEY ("integrationId") REFERENCES "integrations"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_integrations" ADD CONSTRAINT "channels_integrations_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_greetings" ADD CONSTRAINT "channels_greetings_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_dota_accounts" ADD CONSTRAINT "channels_dota_accounts_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_customvars" ADD CONSTRAINT "channels_customvars_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels_commands" ADD CONSTRAINT "channels_commands_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "channels"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels" ADD CONSTRAINT "channels_id_fkey" FOREIGN KEY ("id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "channels" ADD CONSTRAINT "channels_botId_fkey" FOREIGN KEY ("botId") REFERENCES "bots"("id") ON DELETE RESTRICT ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "bots" ADD CONSTRAINT "bots_tokenId_fkey" FOREIGN KEY ("tokenId") REFERENCES "tokens"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
    }
