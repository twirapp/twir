...
export class eventsAddKeywordIdColumn1676474180436 implements MigrationInterface {
    name = 'eventsAddKeywordIdColumn1676474180436'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "channels_events" ADD "keywordId" text`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "channels_events" DROP COLUMN "keywordId"`);
    }
