...
export class addChannelsStreams1665853547398 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "channels_streams" ("id" character varying NOT NULL, "userId" text NOT NULL, "userLogin" text NOT NULL, "userName" text NOT NULL, "gameId" integer NOT NULL, "gameName" text NOT NULL, "communityIds" text array DEFAULT '{}', "type" text NOT NULL, "title" text NOT NULL, "viewerCount" integer NOT NULL, "startedAt" text NOT NULL, "language" text NOT NULL, "thumbnailUrl" text NOT NULL, "tagIds" text array DEFAULT '{}', "isMature" boolean NOT NULL, "parsedMessages" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_d2b19f073bd39c68e9a9c6cca32" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
