...
export class eventsAddGreeting1677518635168 implements MigrationInterface {
    name = 'eventsAddGreeting1677518635168'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."channels_events_type_enum" RENAME TO "channels_events_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."channels_events_type_enum" AS ENUM('FOLLOW', 'SUBSCRIBE', 'RESUBSCRIBE', 'SUB_GIFT', 'REDEMPTION_CREATED', 'COMMAND_USED', 'FIRST_USER_MESSAGE', 'RAIDED', 'TITLE_OR_CATEGORY_CHANGED', 'STREAM_ONLINE', 'STREAM_OFFLINE', 'ON_CHAT_CLEAR', 'DONATE', 'KEYWORD_MATCHED', 'GREETING_SENDED')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."channels_events_type_enum_old" AS ENUM('FOLLOW', 'SUBSCRIBE', 'RESUBSCRIBE', 'SUB_GIFT', 'REDEMPTION_CREATED', 'COMMAND_USED', 'FIRST_USER_MESSAGE', 'RAIDED', 'TITLE_OR_CATEGORY_CHANGED', 'STREAM_ONLINE', 'STREAM_OFFLINE', 'ON_CHAT_CLEAR', 'DONATE', 'KEYWORD_MATCHED')`);
