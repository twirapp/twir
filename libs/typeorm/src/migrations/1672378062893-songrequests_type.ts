...
export class songrequestsType1672378062893 implements MigrationInterface {
  name = 'songrequestsType1672378062893';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TYPE "public"."channels_commands_module_enum" AS ENUM('CUSTOM', 'DOTA', 'MODERATION', 'MANAGE', 'SONGREQUEST')`);
    await queryRunner.query(`ALTER TABLE "channels_commands"
    ...
    await queryRunner.query(`ALTER TABLE "channels_commands"
        ALTER COLUMN "module" SET DEFAULT 'CUSTOM'`);
    await queryRunner.query(`DROP TYPE "public"."channels_commands_module_enum_old"`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "public"."channels_commands_module_enum_old" AS ENUM('CUSTOM', 'DOTA', 'MODERATION', 'MANAGE')`);
    await queryRunner.query(`ALTER TABLE "channels_commands"
        ALTER COLUMN "module" DROP DEFAULT`);
