...
export class addStatsCommandModule1680516903009 implements MigrationInterface {
  name = 'addStatsCommandModule1680516903009';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."channels_commands_module_enum" AS ENUM('CUSTOM', 'DOTA', 'MODERATION', 'MANAGE', 'SONGREQUEST', 'TTS', 'STATS')`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."channels_commands_module_enum_old" AS ENUM('CUSTOM', 'DOTA', 'MODERATION', 'MANAGE', 'SONGREQUEST', 'TTS')`,
    );
    await queryRunner.query(`ALTER TABLE "channels_commands" ALTER COLUMN "module" DROP DEFAULT`);
    await queryRunner.query(
