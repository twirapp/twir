...
func (c *Client) GetChannelChatChatters(params *GetChatChattersParams) (
	*GetChatChattersResponse,
	error,
) {
...
func (c *Client) GetChannelEmotes(params *GetChannelEmotesParams) (
...
func (c *Client) SendChatAnnouncement(params *SendChatAnnouncementParams) (
...
func (c *Client) UpdateChatSettings(params *UpdateChatSettingsParams) (
...
//   - spring_green
//   - yellow_green
func (c *Client) UpdateUserChatColor(params *UpdateUserChatColorParams) (
...
type SendChatMessageParams struct {
	BroadcasterID        string `query:"broadcaster_id"`                   // required
	SenderID             string `query:"sender_id"`                        // required
	Message              string `json:"message"`                           // upto 500 chars, thereafter str is truncated
	ReplyParentMessageID string `json:"reply_parent_message_id,omitempty"` // The ID of the chat message being replied to.
}

type SendChatMessageMessageDropReason struct {
...
type SendChatMessageMessage struct {
	...
	DropReason []SendChatMessageMessageDropReason `json:"drop_reason"`
}

type ManyChatMessages struct {
	Messages []SendChatMessageMessage `json:"data"`
}
...
func (c *Client) SendChatMessage(params *SendChatMessageParams) (*SendChatMessageResponse, error) {
	resp, err := c.postAsJSON("/chat/messages", &ManyChatMessages{}, params)
	if err != nil {
		return nil, err
	}

	chatResp := &SendChatMessageResponse{}
	resp.HydrateResponseCommon(&chatResp.ResponseCommon)
	chatResp.Data.Messages = resp.Data.(*ManyChatMessages).Messages
