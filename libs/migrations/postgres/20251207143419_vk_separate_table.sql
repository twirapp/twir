...
INSERT INTO channels_integrations_vk (channel_id,
																			access_token,
																			username,
																			avatar,
																			created_at,
...
WHERE ci."integrationId" = (SELECT id FROM public.integrations WHERE service = 'VK' LIMIT 1)
...
DROP TABLE IF EXISTS channels_integrations_vk;
-- +goose StatementEnd
