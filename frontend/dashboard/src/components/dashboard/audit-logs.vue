	...
	<Card :content-style="{ padding: '0px', height: '80%' }">
		<NScrollbar trigger="none">
			<TransitionGroup name="list">
				<div v-for="log of logs" :key="log.id" class="flex min-h-[50px] gap-2.5 px-2.5 select-text border-b-[color:var(--n-border-color)] border-b border-solid items-center">
