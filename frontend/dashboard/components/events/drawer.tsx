									...
									<div className={cardClasses.classes.label}>
										<Flex gap={'xs'} justify={'space-between'}>
											...
											<Box
												...
												onClick={() => {
													form.setFieldValue(
														`operations.${operationIndex}.enabled`,
														!form.values.operations[operationIndex]?.enabled,
													);
												}}
											>
												<Text size={14} style={{ textAlign: 'center' }}>
													{form.values.operations[operationIndex]?.enabled
														? <IconCheck color={'rgb(9, 146, 104)'} size={17} style={{ paddingTop: 7 }} />
														: <IconX color={'rgb(224, 49, 49)'} size={17} style={{ paddingTop: 7 }} />
													}
													{form.values.operations[operationIndex]?.enabled
														? `Enabled`
														: `Disabled`
											...
											<Group>
												...
												<ActionIcon variant={'default'}
																		onClick={() => form.removeListItem('operations', operationIndex)}>
													<IconX />
												</ActionIcon>
