...
export type ChatOverlayWithAdditionalDataQueryVariables = Exact<{ [key: string]: never; }>;


export type ChatOverlayWithAdditionalDataQuery = { __typename?: 'Query', authenticatedUser: { __typename?: 'AuthenticatedUser', id: string, twitchProfile: { __typename?: 'TwirUserTwitchInfo', login: string, displayName: string, profileImageUrl: string } }, twitchGetGlobalBadges: { __typename?: 'TwirTwitchGlobalBadgeResponse', badges: Array<{ __typename?: 'TwitchBadge', set_id: string, versions: Array<{ __typename?: 'TwitchBadgeVersion', id: string, image_url_1x: string, image_url_2x: string, image_url_4x: string }> }> }, twitchGetChannelBadges: { __typename?: 'TwirTwitchChannelBadgeResponse', badges: Array<{ __typename?: 'TwitchBadge', set_id: string, versions: Array<{ __typename?: 'TwitchBadgeVersion', id: string, image_url_1x: string, image_url_2x: string, image_url_4x: string }> }> } };
