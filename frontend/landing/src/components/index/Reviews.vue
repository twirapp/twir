...
const reviews = [
{
  ...
  },
  {
  ...
  },
	{
		...
		username: 'promotive',
		roles: ['Streamer'],
		comment: 'Started used Twir in 2017, now it\'s a robust, feature-rich bot for streamers — complete automation for advanced chat functionality.',
	...
	},
	{
		...
		comment: 'Streamline broadcasts: bot controls, configures & monitors. Integrated 3rd-party tools enable dashboard-based basic setup.',
		avatarUrl: 'https://static-cdn.jtvnw.net/jtv_user_pictures/b73f81e7-3fe1-415b-a543-4fe164d16e56-profile_image-70x70.png',
		rating: 5,
	},
];
...
.reviews-bg {
	background: radial-gradient(ellipse at top, #270a3b, transparent), radial-gradient(ellipse at bottom, #000, transparent);
}
</style>
