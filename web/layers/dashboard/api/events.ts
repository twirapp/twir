...
import type {
	Event as GqlEvent,
	EventOperation as GqlEventOperation,
	EventOperationFilter as GqlEventOperationFilter,
} from '@/gql/graphql'
...
export type EventFilter = GqlEventOperationFilter
...
export const useEventsApi = createGlobalState(() => {
	...
	const useQueryEventById = (id: string) =>
		useQuery({
			query: graphql(`
	...
	const useMutationEnableOrDisableEvent = () =>
		useMutation(
			graphql(`
