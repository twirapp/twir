				...
				<template v-if="table.getRowModel().rows?.length">
					...
					>
						<TableCell
							...
							:key="cell.id"
							class="overflow-hidden md:break-all"
							:class="{
							...
							<slot name="empty-message">
								<div class="flex flex-col items-center justify-center">
									<Icon
										...
										class="size-12"
									/>
									<span class="text-2xl font-medium">{{ t('sharedTexts.noData') }}</span>
								</div>
							</slot>
						</TableCell>
					</TableRow>
		...
		>
			...
			>
				<div
					...
					class="my-2 cursor-pointer px-2"
				>
					<FlexRender
						:render="cell.column.columnDef.cell"
						:props="cell.getContext()"
				...
				>
					<FlexRender
						...
						class="text-sm text-zinc-400/80"
					/>
					<FlexRender
						:render="cell.column.columnDef.cell"
						:props="cell.getContext()"
				...
				<div
					v-else
					class="flex h-auto justify-end px-2 py-2"
				>
					<FlexRender
						:render="cell.column.columnDef.cell"
						:props="cell.getContext()"
