	...
	<UiCard class="p-0">
		<UiCardContent class="p-0">
			<div class="flex flex-row justify-between items-center px-2 py-2 border-b">
				<UiCardTitle class="text-base">{{ t('songRequests.player.title') }}</UiCardTitle>
				<div class="flex gap-1">
					...
					<UiButton variant="outline" size="icon" class="size-8" @click="openSettingsModal">
		...
		<UiCardFooter class="flex-col items-start gap-4 border-t pt-2">
					...
					<UiAlertDialog>
						...
						<UiAlertDialogContent>
							...
							<UiAlertDialogFooter>
								...
								<UiAlertDialogAction @click="banUser(currentVideo.orderedById)">
									{{ t('deleteConfirmation.confirm') }}
								</UiAlertDialogAction>
							</UiAlertDialogFooter>
						</UiAlertDialogContent>
