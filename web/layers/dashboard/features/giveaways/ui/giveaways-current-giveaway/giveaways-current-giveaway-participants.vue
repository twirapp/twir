...
import type { BadgeVariants } from '#layers/dashboard/components/ui/badge'
...
<template>
	<div class="flex-1 flex flex-col h-full min-h-0">
		<div class="p-2 border-b">
			<UiInput v-model="searchTerm" :placeholder="t('sharedTexts.searchPlaceholder')" class="h-10" />
		</div>
		<div ref="participantsRef" class="overflow-y-auto h-full flex-1">
			...
			>
				...
				>
					...
					<UiBadge v-if="filteredParticipants[virtualRow.index].isWinner" variant="success">
