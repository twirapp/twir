...
<template>
	<UiDialog :open="open" @update:open="emit('update:open', $event)">
		<UiDialogContent
			...
			@keypress.stop
		>
			<UiDialogHeader class="px-6 pt-6 pb-4 border-b">
				...
				<div class="flex-1 flex flex-col border-r">
					...
					<div class="flex items-center gap-4 px-4 py-3 border-b bg-muted/30">
						<div class="flex items-center gap-2">
							<UiLabel for="refresh-interval" class="text-xs">Refresh Interval (seconds):</UiLabel>
							<input
								id="refresh-interval"
						...
						<div class="flex items-center gap-2 ml-auto">
							...
							/>
							<UiLabel for="preview-toggle" class="text-xs cursor-pointer flex items-center gap-1">
					...
					<!-- Tabs -->
					<UiTabs v-model="activeTab" class="flex-1 flex flex-col" @keydown.stop @keyup.stop>
						<UiTabsList class="w-full justify-start rounded-none border-b bg-muted/30 px-4">
							<UiTabsTrigger value="html">HTML</UiTabsTrigger>
							<UiTabsTrigger value="css">CSS</UiTabsTrigger>
							<UiTabsTrigger value="js">JavaScript</UiTabsTrigger>
						</UiTabsList>

						<UiTabsContent value="html" class="flex-1 mt-0 p-0" @keydown.stop @keyup.stop>
							<VueMonacoEditor
						...
						<UiTabsContent value="css" class="flex-1 mt-0 p-0" @keydown.stop @keyup.stop>
							<VueMonacoEditor
						...
						<UiTabsContent value="js" class="flex-1 mt-0 p-0" @keydown.stop @keyup.stop>
							<VueMonacoEditor
			...
			<UiDialogFooter class="px-6 py-4 border-t">
