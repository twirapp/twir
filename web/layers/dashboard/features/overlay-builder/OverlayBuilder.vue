...
<template>
	<div class="w-full h-full flex flex-col bg-background overflow-hidden">
		...
		<!-- Add Layer Dialog -->
		<UiDialog v-model:open="showAddLayerDialog">
			<UiDialogContent class="sm:max-w-md">
				<UiDialogHeader>
					<UiDialogTitle>Add New Layer</UiDialogTitle>
					<UiDialogDescription>
						Choose a layer type to add to your overlay
					</UiDialogDescription>
				</UiDialogHeader>
				<div class="grid gap-4 py-4">
					<UiButton variant="outline" class="h-auto p-4 flex flex-col items-start" @click="addHtmlLayer">
					...
					<UiButton variant="outline" class="h-auto p-4 flex flex-col items-start" @click="addImageLayer">
						<div class="flex items-center gap-2 mb-2">
