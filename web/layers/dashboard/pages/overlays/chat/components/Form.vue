...
<template>
	...
	<div v-else class="flex gap-8 w-full">
		...
		<div class="space-y-4 animate-in fade-in slide-in-from-bottom-3 duration-500 delay-100">
			...
			<UiFormField v-slot="{ componentField }" name="preset">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.style') }}</UiFormLabel>
					<UiSelect v-bind="componentField">
						<UiFormControl>
							<UiSelectTrigger class="transition-all">
								<UiSelectValue />
							</UiSelectTrigger>
						</UiFormControl>
						<UiSelectContent>
							<UiSelectItem v-for="option in styleSelectOptions" :key="option.value" :value="option.value">
								{{ option.label }}
							</UiSelectItem>
						</UiSelectContent>
					</UiSelect>
			...
			<UiFormField v-slot="{ componentField }" name="direction">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.direction') }}</UiFormLabel>
					<UiSelect v-bind="componentField">
						<UiFormControl>
							<UiSelectTrigger class="transition-all">
								<UiSelectValue />
						...
						<UiSelectContent>
							<UiSelectItem v-for="option in directionOptions" :key="option.value" :value="option.value">
								{{ option.label }}
							</UiSelectItem>
						</UiSelectContent>
					</UiSelect>
			...
			<UiFormField v-slot="{ componentField }" name="animation">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.animation') || 'Animation' }}</UiFormLabel>
					<UiSelect v-bind="componentField">
						<UiFormControl>
							<UiSelectTrigger class="transition-all">
								<UiSelectValue />
						...
						<UiSelectContent>
							<UiSelectItem :value="ChatOverlayAnimation.Default">Default</UiSelectItem>
							<UiSelectItem :value="ChatOverlayAnimation.Disabled">Disabled</UiSelectItem>
						</UiSelectContent>
					</UiSelect>
					<UiFormMessage />
				</UiFormItem>
			...
			<div class="space-y-3 p-3 rounded-lg border bg-muted/30 transition-all hover:bg-muted/50">
				<UiFormField v-slot="{ value, handleChange }" name="hideBots">
					<UiFormItem class="flex items-center justify-between">
						<UiFormLabel class="cursor-pointer text-sm font-medium transition-colors hover:text-foreground">
							{{ t('overlays.chat.hideBots') }}
						</UiFormLabel>
						<UiFormControl>
							<UiSwitch :model-value="value" class="transition-all" @update:model-value="handleChange" />
						</UiFormControl>
					</UiFormItem>
				</UiFormField>

				<UiFormField v-slot="{ value, handleChange }" name="hideCommands">
					<UiFormItem class="flex items-center justify-between">
						<UiFormLabel class="cursor-pointer text-sm font-medium transition-colors hover:text-foreground">
				...
				<UiFormField v-slot="{ value, handleChange }" name="showBadges">
					<UiFormItem class="flex items-center justify-between">
						<UiFormLabel class="cursor-pointer text-sm font-medium transition-colors hover:text-foreground">
				...
				<UiFormField v-if="formValue.preset === 'boxed'" v-slot="{ value, handleChange }" name="showAnnounceBadge">
					<UiFormItem class="flex items-center justify-between">
						<UiFormLabel class="cursor-pointer text-sm font-medium transition-colors hover:text-foreground">
							{{ t('overlays.chat.showAnnounceBadge') }}
						</UiFormLabel>
						<UiFormControl>
							<UiSwitch :model-value="value" :disabled="!formValue.showBadges" class="transition-all" @update:model-value="handleChange" />
						</UiFormControl>
					</UiFormItem>
				</UiFormField>
			</div>

			<UiFormField v-slot="{ componentField }" name="paddingContainer">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.paddingContainer') }} ({{ formValue.paddingContainer }}px)</UiFormLabel>
					<UiFormControl>
						<UiSlider
		...
		<div class="space-y-4 animate-in fade-in slide-in-from-bottom-3 duration-500 delay-200">
			...
			<div class="space-y-2 transition-all">
				<UiLabel class="text-sm font-medium">{{ t('overlays.chat.fontFamily') }}</UiLabel>
				<FontSelector
			...
			<UiFormField v-slot="{ componentField }" name="fontWeight">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.fontWeight') }}</UiFormLabel>
					<UiSelect v-bind="componentField">
						<UiFormControl>
							<UiSelectTrigger class="transition-all">
								<UiSelectValue />
			...
			<UiFormField v-slot="{ componentField }" name="fontStyle">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.fontStyle') }}</UiFormLabel>
					<UiSelect v-bind="componentField">
						<UiFormControl>
							<UiSelectTrigger class="transition-all">
								<UiSelectValue />
			...
			<UiFormField v-slot="{ componentField }" name="fontSize">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.fontSize') }} ({{ formValue.fontSize }}px)</UiFormLabel>
					<UiFormControl>
						<UiSlider
							:model-value="[componentField.modelValue]"
							:min="12"
		...
		<div class="space-y-4 animate-in fade-in slide-in-from-bottom-3 duration-500 delay-300">
			...
			<UiFormField v-slot="{ componentField }" name="chatBackgroundColor">
				<UiFormItem>
					<div class="flex items-center justify-between">
						<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.backgroundColor') }}</UiFormLabel>
						<UiButton
							type="button"
							size="sm"
							variant="ghost"
			...
			<div class="space-y-2 transition-all">
				<UiLabel class="text-sm font-medium">{{ t('overlays.chat.textShadow') }} ({{ formValue.textShadowSize }}px)</UiLabel>
				<div class="flex items-center gap-2">
					<UiFormField v-slot="{ componentField }" name="textShadowColor">
						<UiFormItem>
							<UiFormControl>
								<UiColorPicker
									v-bind="componentField"
					...
					<UiFormField v-slot="{ componentField }" name="textShadowSize">
		...
		<div class="space-y-4 animate-in fade-in slide-in-from-bottom-3 duration-500 delay-400">
			...
			<UiFormField v-slot="{ componentField }" name="messageHideTimeout">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.hideTimeout') }} ({{ formValue.messageHideTimeout }}s)</UiFormLabel>
					<UiFormControl>
						<UiSlider
							:model-value="[componentField.modelValue]"
							:min="0"
			...
			<UiFormField v-slot="{ componentField }" name="messageShowDelay">
				<UiFormItem>
					<UiFormLabel class="text-sm font-medium">{{ t('overlays.chat.showDelay') }} ({{ formValue.messageShowDelay }}s)</UiFormLabel>
					<UiFormControl>
						<UiSlider
							:model-value="[componentField.modelValue]"
							:min="0"
