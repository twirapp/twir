...
import { useAdminAuditLogs } from '~~/layers/dashboard/app/api/admin/audit-logs'
import { Badge } from '@/components/ui/badge'
import { usePagination } from '~~/layers/dashboard/app/composables/use-pagination.js'
import AuditTableValue from '~~/layers/dashboard/app/features/admin-panel/audit-logs/ui/audit-table-value.vue'
