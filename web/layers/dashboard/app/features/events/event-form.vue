...
import { EventType, useEventsApi } from '~~/layers/dashboard/app/api/events'
import { Button } from '@/components/ui/button'
import { toast } from 'vue-sonner'
import EventVariables from '~~/layers/dashboard/app/features/events/components/event-variables.vue'
import { eventFormSchema } from '~~/layers/dashboard/app/features/events/event-form-schema.js'
