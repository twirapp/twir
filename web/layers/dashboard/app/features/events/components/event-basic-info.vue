...
import { useCommandsApi } from '~~/layers/dashboard/app/api/commands/commands'

// oxlint-disable-next-line consistent-type-imports
import { EventType } from '~~/layers/dashboard/app/api/events.js'
import { useKeywordsApi } from '~~/layers/dashboard/app/api/keywords'
import TwitchRewardsSelector from '~~/layers/dashboard/app/components/rewardsSelector.vue'
...
import { EventsOptions } from '~~/layers/dashboard/app/features/events/constants/events.js'
import { getEventName } from '~~/layers/dashboard/app/features/events/constants/helpers.js'
import PlatformSelector from '~~/layers/dashboard/app/components/platform-selector.vue'
import { cn } from '~~/layers/dashboard/app/lib/utils'
