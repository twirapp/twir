...
import { useCommandsApi } from '~~/layers/dashboard/app/api/commands/commands.js'
import { useVariablesApi } from '~~/layers/dashboard/app/api/variables.js'
...
import VariableInput from '~~/layers/dashboard/app/components/variable-input.vue'
import OperationActionSelector from '~~/layers/dashboard/app/features/events/components/operation-action-selector.vue'
import OperationInputAlert from '~~/layers/dashboard/app/features/events/components/operation-input-alert.vue'
import OperationInputObsSelector from '~~/layers/dashboard/app/features/events/components/operation-input-obs-selector.vue'
import { flatOperations } from '~~/layers/dashboard/app/features/events/constants/helpers'
import { EventOperationType } from '~/gql/graphql.js'

import type { EventFilter, EventOperation } from '~~/layers/dashboard/app/api/events'
