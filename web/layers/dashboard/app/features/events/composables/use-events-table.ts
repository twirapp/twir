...
import type { Event , EventType } from '~~/layers/dashboard/app/api/events'

import { useEventsApi } from '~~/layers/dashboard/app/api/events'
import { Badge } from '@/components/ui/badge'
import { flatEvents, getEventName } from '~~/layers/dashboard/app/features/events/constants/helpers'
import EventsTableOperations from '~~/layers/dashboard/app/features/events/ui/events-table-operations.vue'
