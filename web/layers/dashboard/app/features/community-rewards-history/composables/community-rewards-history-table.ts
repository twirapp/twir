...
import type { Redemption } from '~~/layers/dashboard/app/api/community-rewards'

import { useCommunityRewardsApi } from '~~/layers/dashboard/app/api/community-rewards'
...
import { valueUpdater } from '~~/layers/dashboard/app/helpers/value-updater'
