...
import { type Font, FontSelector } from '~~/layers/dashboard/app/lib/fontsource'
import { useForm } from 'vee-validate'
import { computed, ref, toRaw, watch } from 'vue'

import { useProfile, useUserAccessFlagChecker } from '~~/layers/dashboard/app/api/auth'
import { useBeRightBackOverlayApi } from '~~/layers/dashboard/app/api/overlays-be-right-back'
...
import { useCopyOverlayLink } from '~~/layers/dashboard/app/components/overlays/copyOverlayLink.js'
...
const brbIframeUrl = computed(() => {
	...
	return `${window.location.origin}/o/${selectedDashboardApiKey.value}/brb`
})
