...
import GiveawaysCurrentGiveawayParticipants
	from '~~/layers/dashboard/app/features/giveaways/ui/giveaways-current-giveaway/giveaways-current-giveaway-participants.vue';
import GiveawaysCurrentGiveawayWinners
	from '~~/layers/dashboard/app/features/giveaways/ui/giveaways-current-giveaway/giveaways-current-giveaway-winners.vue';
