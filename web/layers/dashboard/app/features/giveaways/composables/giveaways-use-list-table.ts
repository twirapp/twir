...
import type { Giveaway } from '~~/layers/dashboard/app/api/giveaways.js';
...
import GiveawaysCreateDialog from '~~/layers/dashboard/app/features/giveaways/ui/giveaways-create-dialog.vue';
