...
import type { TimerResponse } from '~~/layers/dashboard/app/api/timers'

import { useTimersApi } from '~~/layers/dashboard/app/api/timers'
import TimersTableActions from '~~/layers/dashboard/app/features/timers/ui/timers-table-actions.vue'
