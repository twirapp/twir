...
import { useTwitchRewardsNew } from '~~/layers/dashboard/app/api/twitch.js'
import RewardFallbackImg from '~~/layers/dashboard/app/assets/images/reward-fallback.png'
