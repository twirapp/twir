...
import { useDashboard, useProfile } from '~~/layers/dashboard/app/api/auth'
import { useCommandMenuData } from '~~/layers/dashboard/app/api/command-menu'
...
import { useIsMac } from '~~/layers/dashboard/app/composables/useIsMac'
import { footerNavigationItems, getFlatNavigationItems } from '~~/layers/dashboard/app/config/navigation'
import { usePublicPageHref } from '~~/layers/dashboard/app/layout/use-public-page-href'
