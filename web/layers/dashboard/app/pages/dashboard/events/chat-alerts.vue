...
import { useProfile } from '~~/layers/dashboard/app/api/auth'
import BanSettings from '~~/layers/dashboard/app/features/chat-alerts/ui/ban-settings.vue'
import ChatAlertsRewardsSettings from '~~/layers/dashboard/app/features/chat-alerts/ui/chat-alerts-rewards-settings.vue'
import Settings from '~~/layers/dashboard/app/features/chat-alerts/ui/settings.vue'
