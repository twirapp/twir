...
import AuditLogs from "~~/layers/dashboard/app/components/dashboard/audit-logs.vue";
import Chat from "~~/layers/dashboard/app/components/dashboard/chat.vue";
import CustomWidget from "~~/layers/dashboard/app/components/dashboard/custom-widget.vue";
import Events from "~~/layers/dashboard/app/components/dashboard/events.vue";
import Stream from "~~/layers/dashboard/app/components/dashboard/stream.vue";
import WidgetStackTabs from "~~/layers/dashboard/app/components/dashboard/widget-stack-tabs.vue";
import { useWidgetStacks } from "~~/layers/dashboard/app/components/dashboard/widget-stacks.js";
import { type WidgetItem, useWidgets } from "~~/layers/dashboard/app/components/dashboard/widgets.js";
...
import { useIsMobile } from "~~/layers/dashboard/app/composables/use-is-mobile";
import { useDashboardWidgetsCreateCustom } from "~~/layers/dashboard/app/api/dashboard-widgets-layout.js";
