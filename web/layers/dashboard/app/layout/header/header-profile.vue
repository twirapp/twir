...
import { useLogout, useProfile } from '~~/layers/dashboard/app/api/auth'
...
import { useTheme } from '~~/layers/dashboard/app/composables/use-theme.js'
import { AVAILABLE_LOCALES } from '~~/layers/dashboard/app/config/i18n-locales.js'
import { Button } from '@/components/ui/button'
import KickIcon from '~~/layers/dashboard/app/components/kick-icon.vue'
import TwitchIcon from '~~/layers/dashboard/app/components/twitch-icon.vue'
