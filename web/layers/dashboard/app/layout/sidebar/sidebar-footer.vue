...
import { footerNavigationItems } from "~~/layers/dashboard/app/config/navigation";
import { useNotifications } from "~~/layers/dashboard/app/composables/use-notifications";
