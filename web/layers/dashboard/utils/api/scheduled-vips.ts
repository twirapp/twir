...
export const useScheduledVipsApi = createGlobalState(() => {
	const useQueryScheduledVips = () => useQuery({
		variables: {},
	...
	const useMutationCreateScheduledVip = () => useMutation(
		graphql(`
	...
	const useMutationRemoveScheduledVip = () => useMutation(
		graphql(`
	...
	const useMutationUpdateScheduledVip = () => useMutation(
		graphql(`
