...
import { ChatBox } from '~~/lib/frontend-chat'
import { computed, onMounted, onUnmounted, ref } from 'vue'

import type { Message } from '~~/lib/frontend-chat'

import { useChatOverlaySocket } from '~~/layers/overlays/app/composables/chat/use-chat-overlay-socket'
import {
	type ChatMessage,
	type ChatSettings,
	knownBots,
	useChatTmi,
} from '~~/layers/overlays/app/composables/tmi/use-chat-tmi'
