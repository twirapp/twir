...
<template>
	<div class="text-white container mb-4 flex flex-col gap-4">
		...
		<p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the TwirApp website and the TwirApp chat bot (together, or individually, the "Service") operated by TwirApp ("us", "we", or "our", "site").</p>

		<p>
			The Site provides the following services: Cloud based service that allows users to use a chat bot to moderate their Twitch (https://twitch.tv) chat rooms. (Services). You agree that by accessing the Site and/or Services, you have read, understood, and agree to be bound by all of these Terms and Conditions.
		...
		<p>We are constantly updating the offerings on the Service. We may experience delays in updating information on the Service and in our advertising on other websites. The information found on the Service may contain errors or inaccuracies and may not be complete or current. We reserve the right to change or update information and to correct errors, inaccuracies, or omissions at any time without prior notice.</p>
		...
		<p>You are responsible for maintaining the confidentiality of your account and password, including but not limited to the restriction of access to your computer and/or account. You must notify us immediately upon becoming aware of any breach of security or unauthorized use of your account.</p>
		<p>We reserve the right to refuse service, terminate accounts, remove or edit content, or suspend accounts at our sole discretion.</p>
		...
		<p>The Service and its original content (excluding Content provided by users), features, and functionality are and will remain the exclusive property of TwirApp LLC and its licensors. The Service is protected by copyright, trademark, and other laws of the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of TwirApp LLC.</p>
		...
		<p>If you wish to terminate your account, please contact us to request an account deletion.</p>
