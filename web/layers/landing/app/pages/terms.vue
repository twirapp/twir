...
<template>
	...
	<div class="text-white container mx-auto mb-4 flex flex-col gap-4">
		...
		<p>
			...
			TwirApp website and the TwirApp chat bot (together, or individually, the "Service") operated
			by TwirApp ("us", "we", or "our", "site").
		</p>

		<p>
			The Site provides the following services: Cloud based service that allows users to use a chat
			bot to moderate their Twitch (https://twitch.tv) chat rooms. (Services). You agree that by
			accessing the Site and/or Services, you have read, understood, and agree to be bound by all of
			these Terms and Conditions. If you do not agree with all of these Terms and Conditions, then
			you are prohibited from using the Site and Services and you must discontinue use immediately.
			We recommend that you print a copy of these Terms and Conditions for future reference.
		</p>

		<h2 class="text-2xl">Acceptance of Terms</h2>
		<p>
		...
		<h2 class="text-2xl">Availability, Errors, and Inaccuracies</h2>
		<p>
			We are constantly updating the offerings on the Service. We may experience delays in updating
			information on the Service and in our advertising on other websites. The information found on
			the Service may contain errors or inaccuracies and may not be complete or current. We reserve
		...
		<ul>
			<li>
				The Content is yours (you own it) and/or you have the right to use it and grant us the
		...
		<p>
			You retain any and all rights to any Content you submit, post, or display on or through the
			Service. However, by posting Content using the Service, you grant us the right and license to
		...
		<h2 class="text-2xl">Copyright Policy</h2>
		<p>
		...
		<p>
			...
			claim via email <b>contact@twir.app</b>. Include in your claim a detailed description of the
			alleged Infringement as outlined under "DMCA Notice and Procedure for Copyright Infringement
			Claims" below.
		</p>
		...
		<h2 class="text-2xl">Intellectual Property</h2>
		<p>
			The Service and its original content (excluding Content provided by users), features, and
			functionality are and will remain the exclusive property of TwirApp LLC and its licensors. The
			...
			service without the prior written consent of TwirApp LLC.
		</p>

		<h2 class="text-2xl">Termination</h2>
		<p>
		...
		<h2 class="text-2xl">Governing Law</h2>
		<p>
