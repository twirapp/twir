...
<template>
	<section id="features">
		<div class="container flex flex-col items-center py-24 md:px-8 px-5 text-center purple-gradient">
			<h2 class="font-semibold text-[#B0ADFF] text-base uppercase tracking-wider mb-3">
				Features
			</h2>
			...
			<div class="flex flex-col items-center gap-2 pt-16">
				<p class="max-w-3xl text-[#ADB0B8] text-sm leading-normal italic">
					This is by no means an exhaustive list of the bot's capabilities; it will be continuously updated for you as we strive to bring forth new and innovative features.
				</p>
				<a
