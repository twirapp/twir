		...
		>
			...
			>
				...
				>
					...
					<span class="text-xl text-white font-semibold mb-2">
					...
					>
						{{ prepareDescription(t(`landing.features.items.${feature.id}.description`)) }}
					</p>
				</li>
			</ul>
