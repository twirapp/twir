...
<template>
	<section id="team" class="container mx-auto py-[72px] team">
		<div class="flex flex-col gap-3 p-5">
			<h2 class="font-semibold text-[#B0ADFF] text-base uppercase text-center">Team</h2>
			<h3 class="text-white text-4xl font-bold text-center">They're doing their best for you</h3>
		</div>
			...
			<div v-for="developer of developers" :key="developer.username" class="flex gap-6">
				...
				<div class="flex flex-col">
					...
					<div class="flex mt-4 gap-4">
						<a
							v-for="(value, name) of developer.social"
							:key="name"
							:href="value"
							target="_blank"
