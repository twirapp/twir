...
export type NewCSubscription = { __typename?: 'Subscription', newCommand: { __typename?: 'Command', id: string, name: string, description?: string | null, aliases?: Array<string> | null, createdAt: any, updatedAt: any, responses?: Array<{ __typename?: 'CommandResponse', id: string, commandId: string, text: string, order: number }> | null } };
