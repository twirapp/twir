import { ActionIcon, Badge, Button, Flex, Group, Switch, Table, Text, TextInput } from '@mantine/core';
    ...
    <div>
      ...
      <Table>
        ...
        {commands &&
          ...
          commands
            .filter((c) => {
              const isActiveTab = c.module.toLowerCase() === (router.query.module ? router.query.module[0] : 'custom');
