...
require (
	...
	github.com/twirapp/twir/libs/grpc v0.0.0-20240807231545-3a665c8d4d3a
	github.com/twirapp/twir/libs/integrations v0.0.0-20240807231545-3a665c8d4d3a
	github.com/twirapp/twir/libs/redis_keys v0.0.0-20240807231545-3a665c8d4d3a
