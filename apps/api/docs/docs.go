...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_v1_integrations_spotify.spotifyDto"
                        }
                    },
                    {
                        "type": "string",
    ...
    "definitions": {
        ...
        "github_com_satont_tsuwari_apps_api_internal_api_v1_commands.commandDto": {
            ...
            "properties": {
                ...
                "restrictions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_satont_tsuwari_apps_api_internal_api_v1_commands.restrictionsDto"
                    }
                },
                "visible": {
                    "type": "boolean"
        ...
        "github_com_satont_tsuwari_apps_api_internal_api_v1_commands.restrictionsDto": {
            "type": "object",
            "properties": {
                "type": {
                    "type": "string",
        ...
        "internal_api_v1_commands.commandDto": {
            ...
            "properties": {
                ...
                "restrictions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_api_v1_commands.restrictionsDto"
                    }
                },
                "visible": {
                    "type": "boolean"
        ...
        "internal_api_v1_commands.restrictionsDto": {
            "type": "object",
            "properties": {
                "type": {
                    "type": "string",
        ...
        "model.ChannelsCommands": {
            ...
            "properties": {
                ...
                "restrictions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.CommandRestriction"
                    }
                },
                "visible": {
                    "type": "boolean"
