...
@Module({
  imports: [CommandsModule, GreetingsModule, TimersModule, SpotifyModule, LastfmModule, KeywordsModule, VariablesModule, ModerationModule, StreamsModule, SettingsModule],
})
