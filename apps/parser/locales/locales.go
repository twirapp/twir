...
type KeysVariablesSongInfoSpotifyTokenExpiredVars struct {
}
type KeysVariablesSongInfoSpotifyTokenExpired struct {
	Vars twiri18n.Vars
}

func (k KeysVariablesSongInfoSpotifyTokenExpired) IsTranslationKey() {
}
func (k KeysVariablesSongInfoSpotifyTokenExpired) GetPath() string {
	return "variables.song.info.spotify_token_expired"
}
func (k KeysVariablesSongInfoSpotifyTokenExpired) GetPathSlice() []string {
	return []string{"variables", "song", "info", "spotify_token_expired"}
}
func (k KeysVariablesSongInfoSpotifyTokenExpired) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysVariablesSongInfoSpotifyTokenExpired) SetVars(vars KeysVariablesSongInfoSpotifyTokenExpiredVars) twiri18n.TranslationKey[KeysVariablesSongInfoSpotifyTokenExpiredVars] {
	k.Vars = twiri18n.Vars{}
	return k
}
...
type KeysVariablesSongInfo struct {
	...
	SpotifyTokenExpired		KeysVariablesSongInfoSpotifyTokenExpired
...
type KeysCommandsDotaOutputsLastGameVars struct {
	Hero		any
	Kda		any
	Result		any
	Duration	any
}
type KeysCommandsDotaOutputsLastGame struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsLastGame) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsLastGame) GetPath() string {
	return "commands.dota.outputs.last_game"
}
func (k KeysCommandsDotaOutputsLastGame) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "last_game"}
}
func (k KeysCommandsDotaOutputsLastGame) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsLastGame) SetVars(vars KeysCommandsDotaOutputsLastGameVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsLastGameVars] {
	k.Vars = twiri18n.Vars{"hero": vars.Hero, "kda": vars.Kda, "result": vars.Result, "duration": vars.Duration}
	return k
}

type KeysCommandsDotaOutputsLossVars struct {
}
type KeysCommandsDotaOutputsLoss struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsLoss) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsLoss) GetPath() string {
	return "commands.dota.outputs.loss"
}
func (k KeysCommandsDotaOutputsLoss) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "loss"}
}
func (k KeysCommandsDotaOutputsLoss) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsLoss) SetVars(vars KeysCommandsDotaOutputsLossVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsLossVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaOutputsWlVars struct {
	Record	any
	WinRate	any
}
type KeysCommandsDotaOutputsWl struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsWl) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsWl) GetPath() string {
	return "commands.dota.outputs.wl"
}
func (k KeysCommandsDotaOutputsWl) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "wl"}
}
func (k KeysCommandsDotaOutputsWl) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsWl) SetVars(vars KeysCommandsDotaOutputsWlVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsWlVars] {
	k.Vars = twiri18n.Vars{"record": vars.Record, "winRate": vars.WinRate}
	return k
}

type KeysCommandsDotaOutputsGmVars struct {
	Medal any
}
type KeysCommandsDotaOutputsGm struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsGm) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsGm) GetPath() string {
	return "commands.dota.outputs.gm"
}
func (k KeysCommandsDotaOutputsGm) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "gm"}
}
func (k KeysCommandsDotaOutputsGm) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsGm) SetVars(vars KeysCommandsDotaOutputsGmVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsGmVars] {
	k.Vars = twiri18n.Vars{"medal": vars.Medal}
	return k
}

type KeysCommandsDotaOutputsNotablePlayersVars struct {
	Players any
}
type KeysCommandsDotaOutputsNotablePlayers struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsNotablePlayers) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsNotablePlayers) GetPath() string {
	return "commands.dota.outputs.notable_players"
}
func (k KeysCommandsDotaOutputsNotablePlayers) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "notable_players"}
}
func (k KeysCommandsDotaOutputsNotablePlayers) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsNotablePlayers) SetVars(vars KeysCommandsDotaOutputsNotablePlayersVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsNotablePlayersVars] {
	k.Vars = twiri18n.Vars{"players": vars.Players}
	return k
}

type KeysCommandsDotaOutputsWinProbabilityVars struct {
	Probability any
}
type KeysCommandsDotaOutputsWinProbability struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsWinProbability) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsWinProbability) GetPath() string {
	return "commands.dota.outputs.win_probability"
}
func (k KeysCommandsDotaOutputsWinProbability) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "win_probability"}
}
func (k KeysCommandsDotaOutputsWinProbability) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsWinProbability) SetVars(vars KeysCommandsDotaOutputsWinProbabilityVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsWinProbabilityVars] {
	k.Vars = twiri18n.Vars{"probability": vars.Probability}
	return k
}

type KeysCommandsDotaOutputsWinVars struct {
}
type KeysCommandsDotaOutputsWin struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsWin) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsWin) GetPath() string {
	return "commands.dota.outputs.win"
}
func (k KeysCommandsDotaOutputsWin) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "win"}
}
func (k KeysCommandsDotaOutputsWin) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsWin) SetVars(vars KeysCommandsDotaOutputsWinVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsWinVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaOutputsMmrVars struct {
	Mmr	any
	Medal	any
}
type KeysCommandsDotaOutputsMmr struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaOutputsMmr) IsTranslationKey() {
}
func (k KeysCommandsDotaOutputsMmr) GetPath() string {
	return "commands.dota.outputs.mmr"
}
func (k KeysCommandsDotaOutputsMmr) GetPathSlice() []string {
	return []string{"commands", "dota", "outputs", "mmr"}
}
func (k KeysCommandsDotaOutputsMmr) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaOutputsMmr) SetVars(vars KeysCommandsDotaOutputsMmrVars) twiri18n.TranslationKey[KeysCommandsDotaOutputsMmrVars] {
	k.Vars = twiri18n.Vars{"mmr": vars.Mmr, "medal": vars.Medal}
	return k
}

type KeysCommandsDotaOutputs struct {
	LastGame	KeysCommandsDotaOutputsLastGame
	Loss		KeysCommandsDotaOutputsLoss
	Wl		KeysCommandsDotaOutputsWl
	Gm		KeysCommandsDotaOutputsGm
	NotablePlayers	KeysCommandsDotaOutputsNotablePlayers
	WinProbability	KeysCommandsDotaOutputsWinProbability
	Win		KeysCommandsDotaOutputsWin
	Mmr		KeysCommandsDotaOutputsMmr
}
type KeysCommandsDotaSuccessMmrUpdatedVars struct {
	Mmr any
}
type KeysCommandsDotaSuccessMmrUpdated struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaSuccessMmrUpdated) IsTranslationKey() {
}
func (k KeysCommandsDotaSuccessMmrUpdated) GetPath() string {
	return "commands.dota.success.mmr_updated"
}
func (k KeysCommandsDotaSuccessMmrUpdated) GetPathSlice() []string {
	return []string{"commands", "dota", "success", "mmr_updated"}
}
func (k KeysCommandsDotaSuccessMmrUpdated) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaSuccessMmrUpdated) SetVars(vars KeysCommandsDotaSuccessMmrUpdatedVars) twiri18n.TranslationKey[KeysCommandsDotaSuccessMmrUpdatedVars] {
	k.Vars = twiri18n.Vars{"mmr": vars.Mmr}
	return k
}

type KeysCommandsDotaSuccess struct {
	MmrUpdated KeysCommandsDotaSuccessMmrUpdated
}
type KeysCommandsDotaErrorsUpdateMmrVars struct {
}
type KeysCommandsDotaErrorsUpdateMmr struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsUpdateMmr) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsUpdateMmr) GetPath() string {
	return "commands.dota.errors.update_mmr"
}
func (k KeysCommandsDotaErrorsUpdateMmr) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "update_mmr"}
}
func (k KeysCommandsDotaErrorsUpdateMmr) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsUpdateMmr) SetVars(vars KeysCommandsDotaErrorsUpdateMmrVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsUpdateMmrVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsNoLastGameVars struct {
}
type KeysCommandsDotaErrorsNoLastGame struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsNoLastGame) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsNoLastGame) GetPath() string {
	return "commands.dota.errors.no_last_game"
}
func (k KeysCommandsDotaErrorsNoLastGame) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "no_last_game"}
}
func (k KeysCommandsDotaErrorsNoLastGame) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsNoLastGame) SetVars(vars KeysCommandsDotaErrorsNoLastGameVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsNoLastGameVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsNoNotablePlayersVars struct {
}
type KeysCommandsDotaErrorsNoNotablePlayers struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsNoNotablePlayers) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsNoNotablePlayers) GetPath() string {
	return "commands.dota.errors.no_notable_players"
}
func (k KeysCommandsDotaErrorsNoNotablePlayers) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "no_notable_players"}
}
func (k KeysCommandsDotaErrorsNoNotablePlayers) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsNoNotablePlayers) SetVars(vars KeysCommandsDotaErrorsNoNotablePlayersVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsNoNotablePlayersVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsSettingsNotFoundVars struct {
}
type KeysCommandsDotaErrorsSettingsNotFound struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsSettingsNotFound) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsSettingsNotFound) GetPath() string {
	return "commands.dota.errors.settings_not_found"
}
func (k KeysCommandsDotaErrorsSettingsNotFound) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "settings_not_found"}
}
func (k KeysCommandsDotaErrorsSettingsNotFound) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsSettingsNotFound) SetVars(vars KeysCommandsDotaErrorsSettingsNotFoundVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsSettingsNotFoundVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsDisabledVars struct {
}
type KeysCommandsDotaErrorsDisabled struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsDisabled) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsDisabled) GetPath() string {
	return "commands.dota.errors.disabled"
}
func (k KeysCommandsDotaErrorsDisabled) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "disabled"}
}
func (k KeysCommandsDotaErrorsDisabled) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsDisabled) SetVars(vars KeysCommandsDotaErrorsDisabledVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsDisabledVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsCommandDisabledVars struct {
}
type KeysCommandsDotaErrorsCommandDisabled struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsCommandDisabled) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsCommandDisabled) GetPath() string {
	return "commands.dota.errors.command_disabled"
}
func (k KeysCommandsDotaErrorsCommandDisabled) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "command_disabled"}
}
func (k KeysCommandsDotaErrorsCommandDisabled) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsCommandDisabled) SetVars(vars KeysCommandsDotaErrorsCommandDisabledVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsCommandDisabledVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsGetDataVars struct {
}
type KeysCommandsDotaErrorsGetData struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsGetData) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsGetData) GetPath() string {
	return "commands.dota.errors.get_data"
}
func (k KeysCommandsDotaErrorsGetData) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "get_data"}
}
func (k KeysCommandsDotaErrorsGetData) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsGetData) SetVars(vars KeysCommandsDotaErrorsGetDataVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsGetDataVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsMmrNegativeVars struct {
}
type KeysCommandsDotaErrorsMmrNegative struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsMmrNegative) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsMmrNegative) GetPath() string {
	return "commands.dota.errors.mmr_negative"
}
func (k KeysCommandsDotaErrorsMmrNegative) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "mmr_negative"}
}
func (k KeysCommandsDotaErrorsMmrNegative) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsMmrNegative) SetVars(vars KeysCommandsDotaErrorsMmrNegativeVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsMmrNegativeVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsNoActiveMatchVars struct {
}
type KeysCommandsDotaErrorsNoActiveMatch struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsNoActiveMatch) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsNoActiveMatch) GetPath() string {
	return "commands.dota.errors.no_active_match"
}
func (k KeysCommandsDotaErrorsNoActiveMatch) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "no_active_match"}
}
func (k KeysCommandsDotaErrorsNoActiveMatch) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsNoActiveMatch) SetVars(vars KeysCommandsDotaErrorsNoActiveMatchVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsNoActiveMatchVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsWinProbabilityUnavailableVars struct {
}
type KeysCommandsDotaErrorsWinProbabilityUnavailable struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsWinProbabilityUnavailable) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsWinProbabilityUnavailable) GetPath() string {
	return "commands.dota.errors.win_probability_unavailable"
}
func (k KeysCommandsDotaErrorsWinProbabilityUnavailable) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "win_probability_unavailable"}
}
func (k KeysCommandsDotaErrorsWinProbabilityUnavailable) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsWinProbabilityUnavailable) SetVars(vars KeysCommandsDotaErrorsWinProbabilityUnavailableVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsWinProbabilityUnavailableVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsGetSettingsVars struct {
}
type KeysCommandsDotaErrorsGetSettings struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsGetSettings) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsGetSettings) GetPath() string {
	return "commands.dota.errors.get_settings"
}
func (k KeysCommandsDotaErrorsGetSettings) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "get_settings"}
}
func (k KeysCommandsDotaErrorsGetSettings) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsGetSettings) SetVars(vars KeysCommandsDotaErrorsGetSettingsVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsGetSettingsVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrorsMmrRequiredVars struct {
}
type KeysCommandsDotaErrorsMmrRequired struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaErrorsMmrRequired) IsTranslationKey() {
}
func (k KeysCommandsDotaErrorsMmrRequired) GetPath() string {
	return "commands.dota.errors.mmr_required"
}
func (k KeysCommandsDotaErrorsMmrRequired) GetPathSlice() []string {
	return []string{"commands", "dota", "errors", "mmr_required"}
}
func (k KeysCommandsDotaErrorsMmrRequired) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaErrorsMmrRequired) SetVars(vars KeysCommandsDotaErrorsMmrRequiredVars) twiri18n.TranslationKey[KeysCommandsDotaErrorsMmrRequiredVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaErrors struct {
	UpdateMmr			KeysCommandsDotaErrorsUpdateMmr
	NoLastGame			KeysCommandsDotaErrorsNoLastGame
	NoNotablePlayers		KeysCommandsDotaErrorsNoNotablePlayers
	SettingsNotFound		KeysCommandsDotaErrorsSettingsNotFound
	Disabled			KeysCommandsDotaErrorsDisabled
	CommandDisabled			KeysCommandsDotaErrorsCommandDisabled
	GetData				KeysCommandsDotaErrorsGetData
	MmrNegative			KeysCommandsDotaErrorsMmrNegative
	NoActiveMatch			KeysCommandsDotaErrorsNoActiveMatch
	WinProbabilityUnavailable	KeysCommandsDotaErrorsWinProbabilityUnavailable
	GetSettings			KeysCommandsDotaErrorsGetSettings
	MmrRequired			KeysCommandsDotaErrorsMmrRequired
}
type KeysCommandsDotaHintsMmrVars struct {
}
type KeysCommandsDotaHintsMmr struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaHintsMmr) IsTranslationKey() {
}
func (k KeysCommandsDotaHintsMmr) GetPath() string {
	return "commands.dota.hints.mmr"
}
func (k KeysCommandsDotaHintsMmr) GetPathSlice() []string {
	return []string{"commands", "dota", "hints", "mmr"}
}
func (k KeysCommandsDotaHintsMmr) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaHintsMmr) SetVars(vars KeysCommandsDotaHintsMmrVars) twiri18n.TranslationKey[KeysCommandsDotaHintsMmrVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaHints struct {
	Mmr KeysCommandsDotaHintsMmr
}
type KeysCommandsDotaMedalsHeraldVars struct {
}
type KeysCommandsDotaMedalsHerald struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsHerald) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsHerald) GetPath() string {
	return "commands.dota.medals.herald"
}
func (k KeysCommandsDotaMedalsHerald) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "herald"}
}
func (k KeysCommandsDotaMedalsHerald) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsHerald) SetVars(vars KeysCommandsDotaMedalsHeraldVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsHeraldVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedalsGuardianVars struct {
}
type KeysCommandsDotaMedalsGuardian struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsGuardian) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsGuardian) GetPath() string {
	return "commands.dota.medals.guardian"
}
func (k KeysCommandsDotaMedalsGuardian) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "guardian"}
}
func (k KeysCommandsDotaMedalsGuardian) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsGuardian) SetVars(vars KeysCommandsDotaMedalsGuardianVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsGuardianVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedalsArchonVars struct {
}
type KeysCommandsDotaMedalsArchon struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsArchon) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsArchon) GetPath() string {
	return "commands.dota.medals.archon"
}
func (k KeysCommandsDotaMedalsArchon) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "archon"}
}
func (k KeysCommandsDotaMedalsArchon) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsArchon) SetVars(vars KeysCommandsDotaMedalsArchonVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsArchonVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedalsLegendVars struct {
}
type KeysCommandsDotaMedalsLegend struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsLegend) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsLegend) GetPath() string {
	return "commands.dota.medals.legend"
}
func (k KeysCommandsDotaMedalsLegend) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "legend"}
}
func (k KeysCommandsDotaMedalsLegend) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsLegend) SetVars(vars KeysCommandsDotaMedalsLegendVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsLegendVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedalsImmortalVars struct {
}
type KeysCommandsDotaMedalsImmortal struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsImmortal) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsImmortal) GetPath() string {
	return "commands.dota.medals.immortal"
}
func (k KeysCommandsDotaMedalsImmortal) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "immortal"}
}
func (k KeysCommandsDotaMedalsImmortal) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsImmortal) SetVars(vars KeysCommandsDotaMedalsImmortalVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsImmortalVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedalsCrusaderVars struct {
}
type KeysCommandsDotaMedalsCrusader struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsCrusader) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsCrusader) GetPath() string {
	return "commands.dota.medals.crusader"
}
func (k KeysCommandsDotaMedalsCrusader) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "crusader"}
}
func (k KeysCommandsDotaMedalsCrusader) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsCrusader) SetVars(vars KeysCommandsDotaMedalsCrusaderVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsCrusaderVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedalsAncientVars struct {
}
type KeysCommandsDotaMedalsAncient struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsAncient) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsAncient) GetPath() string {
	return "commands.dota.medals.ancient"
}
func (k KeysCommandsDotaMedalsAncient) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "ancient"}
}
func (k KeysCommandsDotaMedalsAncient) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsAncient) SetVars(vars KeysCommandsDotaMedalsAncientVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsAncientVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedalsDivineVars struct {
}
type KeysCommandsDotaMedalsDivine struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsDotaMedalsDivine) IsTranslationKey() {
}
func (k KeysCommandsDotaMedalsDivine) GetPath() string {
	return "commands.dota.medals.divine"
}
func (k KeysCommandsDotaMedalsDivine) GetPathSlice() []string {
	return []string{"commands", "dota", "medals", "divine"}
}
func (k KeysCommandsDotaMedalsDivine) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsDotaMedalsDivine) SetVars(vars KeysCommandsDotaMedalsDivineVars) twiri18n.TranslationKey[KeysCommandsDotaMedalsDivineVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsDotaMedals struct {
	Herald		KeysCommandsDotaMedalsHerald
	Guardian	KeysCommandsDotaMedalsGuardian
	Archon		KeysCommandsDotaMedalsArchon
	Legend		KeysCommandsDotaMedalsLegend
	Immortal	KeysCommandsDotaMedalsImmortal
	Crusader	KeysCommandsDotaMedalsCrusader
	Ancient		KeysCommandsDotaMedalsAncient
	Divine		KeysCommandsDotaMedalsDivine
}
type KeysCommandsDota struct {
	Outputs	KeysCommandsDotaOutputs
	Success	KeysCommandsDotaSuccess
	Errors	KeysCommandsDotaErrors
	Hints	KeysCommandsDotaHints
	Medals	KeysCommandsDotaMedals
}
...
type KeysCommandsStatsBotuptimeServicesVars struct {
}
type KeysCommandsStatsBotuptimeServices struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsStatsBotuptimeServices) IsTranslationKey() {
}
func (k KeysCommandsStatsBotuptimeServices) GetPath() string {
	return "commands.stats.botuptime.services"
}
func (k KeysCommandsStatsBotuptimeServices) GetPathSlice() []string {
	return []string{"commands", "stats", "botuptime", "services"}
}
func (k KeysCommandsStatsBotuptimeServices) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsStatsBotuptimeServices) SetVars(vars KeysCommandsStatsBotuptimeServicesVars) twiri18n.TranslationKey[KeysCommandsStatsBotuptimeServicesVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsStatsBotuptimeDownVars struct {
}
type KeysCommandsStatsBotuptimeDown struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsStatsBotuptimeDown) IsTranslationKey() {
}
func (k KeysCommandsStatsBotuptimeDown) GetPath() string {
	return "commands.stats.botuptime.down"
}
func (k KeysCommandsStatsBotuptimeDown) GetPathSlice() []string {
	return []string{"commands", "stats", "botuptime", "down"}
}
func (k KeysCommandsStatsBotuptimeDown) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsStatsBotuptimeDown) SetVars(vars KeysCommandsStatsBotuptimeDownVars) twiri18n.TranslationKey[KeysCommandsStatsBotuptimeDownVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsStatsBotuptimeRecentlyRestartedVars struct {
}
type KeysCommandsStatsBotuptimeRecentlyRestarted struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsStatsBotuptimeRecentlyRestarted) IsTranslationKey() {
}
func (k KeysCommandsStatsBotuptimeRecentlyRestarted) GetPath() string {
	return "commands.stats.botuptime.recently_restarted"
}
func (k KeysCommandsStatsBotuptimeRecentlyRestarted) GetPathSlice() []string {
	return []string{"commands", "stats", "botuptime", "recently_restarted"}
}
func (k KeysCommandsStatsBotuptimeRecentlyRestarted) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsStatsBotuptimeRecentlyRestarted) SetVars(vars KeysCommandsStatsBotuptimeRecentlyRestartedVars) twiri18n.TranslationKey[KeysCommandsStatsBotuptimeRecentlyRestartedVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsStatsBotuptimePingVars struct {
}
type KeysCommandsStatsBotuptimePing struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsStatsBotuptimePing) IsTranslationKey() {
}
func (k KeysCommandsStatsBotuptimePing) GetPath() string {
	return "commands.stats.botuptime.ping"
}
func (k KeysCommandsStatsBotuptimePing) GetPathSlice() []string {
	return []string{"commands", "stats", "botuptime", "ping"}
}
func (k KeysCommandsStatsBotuptimePing) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsStatsBotuptimePing) SetVars(vars KeysCommandsStatsBotuptimePingVars) twiri18n.TranslationKey[KeysCommandsStatsBotuptimePingVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsStatsBotuptimeNoDataVars struct {
	Services	any
	Unavailable	any
}
type KeysCommandsStatsBotuptimeNoData struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsStatsBotuptimeNoData) IsTranslationKey() {
}
func (k KeysCommandsStatsBotuptimeNoData) GetPath() string {
	return "commands.stats.botuptime.no_data"
}
func (k KeysCommandsStatsBotuptimeNoData) GetPathSlice() []string {
	return []string{"commands", "stats", "botuptime", "no_data"}
}
func (k KeysCommandsStatsBotuptimeNoData) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsStatsBotuptimeNoData) SetVars(vars KeysCommandsStatsBotuptimeNoDataVars) twiri18n.TranslationKey[KeysCommandsStatsBotuptimeNoDataVars] {
	k.Vars = twiri18n.Vars{"services": vars.Services, "unavailable": vars.Unavailable}
	return k
}

type KeysCommandsStatsBotuptimeUnavailableVars struct {
}
type KeysCommandsStatsBotuptimeUnavailable struct {
	Vars twiri18n.Vars
}

func (k KeysCommandsStatsBotuptimeUnavailable) IsTranslationKey() {
}
func (k KeysCommandsStatsBotuptimeUnavailable) GetPath() string {
	return "commands.stats.botuptime.unavailable"
}
func (k KeysCommandsStatsBotuptimeUnavailable) GetPathSlice() []string {
	return []string{"commands", "stats", "botuptime", "unavailable"}
}
func (k KeysCommandsStatsBotuptimeUnavailable) GetVars() twiri18n.Vars {
	return k.Vars
}
func (k KeysCommandsStatsBotuptimeUnavailable) SetVars(vars KeysCommandsStatsBotuptimeUnavailableVars) twiri18n.TranslationKey[KeysCommandsStatsBotuptimeUnavailableVars] {
	k.Vars = twiri18n.Vars{}
	return k
}

type KeysCommandsStatsBotuptime struct {
	Services		KeysCommandsStatsBotuptimeServices
	Down			KeysCommandsStatsBotuptimeDown
	RecentlyRestarted	KeysCommandsStatsBotuptimeRecentlyRestarted
	Ping			KeysCommandsStatsBotuptimePing
	NoData			KeysCommandsStatsBotuptimeNoData
	Unavailable		KeysCommandsStatsBotuptimeUnavailable
}
type KeysCommandsStats struct {
	Info		KeysCommandsStatsInfo
	Me		KeysCommandsStatsMe
	Botuptime	KeysCommandsStatsBotuptime
}
...
var Store twiri18n.LocalesStore = twiri18n.LocalesStore{"en": map[string]map[string]map[string]string{"commands": map[string]map[string]string{"marker": map[string]string{"success.marker_created": `Marker created`, "errors.cannot_create_marker": `Cannot create marker. {reason}`}, "nuke": map[string]string{"errors.cannot_get_handeled_messages": `Cannot get handled messages`, "errors.cannot_delete_messages": `Cannot delete messages`, "errors.timeout_duration": `Duration of timeout cannot be longer than 2 weeks`, "hints.nukeTimeArgName": `time, examples: 10m, 10, 1h5m`, "errors.parse_duration": `Cannot parse duration`, "errors.invalid_duration": `Invalid duration. Examples: !nuke 10m phrase, !nuke 10 phrase, !nuke 1h5m phrase`, "errors.cannot_get_users_stats": `Cannot get users stats`}, "predictions": map[string]string{"errors.cannot_cancel_var": `Cannot cancel prediction: {reason}`, "errors.cannot_create_var": `Cannot create prediction: {reason}`, "info.cancel": `✅ Prediction canceled`, "info.resolved": `✅ Prediction resolved`, "hints.startPredictionDuration": `120`, "hints.predictionResolveOutcomeNum": `Variant number, for example: 1,2,3,4,5`, "errors.no_variant": `No prediction variant`, "errors.cannot_get_current": `Cannot get current prediction`, "hints.startPredictionArgVariants": `Yes, win / No, lose`, "errors.cannot_get_current_var": `Cannot get current prediction: {reason}`, "info.locked": `✅ Prediction locked`, "info.started": `✅ Prediction started`, "hints.startPredictionArgTitle": `Will we win this game?`, "errors.cannot_cancel": `Cannot cancel prediction`, "errors.cannot_create": `Cannot create prediction`, "info.no_runed": `No prediction runed`}, "stats": map[string]string{"botuptime.services": `services`, "info.watching_stream_mentioned": `{userName} is watching stream for {userWatching} hours`, "info.watching_stream": `You're watching stream for {userWatching} hours`, "me.emotes": `used emotes`, "botuptime.recently_restarted": `recently restarted`, "botuptime.no_data": `{services} data is {unavailable}`, "botuptime.unavailable": `unavailable`, "me.songs": `songs requests`, "me.watched": `watched`, "me.messages": `messages`, "me.points": `used points`, "botuptime.down": `down`, "botuptime.ping": `pings`}, "channel": map[string]string{"add.category_change": `✅ {categoryName}`, "errors.category_cannot_get": `Cannot get category`, "errors.channel_cannot_get_information": `Cannot get channel information`, "errors.alias_cannot_get_category": `Cannot get category aliases`, "errors.category_cannot_get_error": `Cannot get category: {errorMessage}`, "hints.gameArgName": `Category name or created category alias`, "errors.category_not_found": `Category not found`, "errors.game_not_found": `Game not found on twitch`, "errors.category_cannot_change": `Cannot change category`, "errors.history_title_message": `Cannot get history of titles from database: {reason}`, "errors.broadcaster_twitch_client_cannot_create": `Cannot create broadcaster twitch client`, "errors.broadcaster_twitch_api_client": `Cannot create broadcaster twitch api client: {reason}`, "errors.channel_not_found": `Channel not found`, "errors.category_cannot_change_error": `Cannot change category: {errorMessage}`, "errors.history_game_message": `Cannot find used games in database`}, "games": map[string]string{"errors.duel_with_yourself": `You cannot duel with yourself`, "errors.duel_with_streamer": `You cannot duel with streamer`, "errors.voteban_cannot_set_vote": `Cannot set vote`, "errors.duel_cannot_set_global_cooldown": `Cannot set global cooldown: {reason}`, "errors.roulette_cannot_send_initial_message": `Cannot send initial message`, "errors.duel_cannot_check_user": `Cannot check user in duel: {reason}`, "info.duel_stats": `You have shoot {duels} times · {wins} W – {loses} L ({winrate} WR)`, "errors.roulette_cannot_get_with_settings": `Cannot get roulette settings from database`, "errors.duel_cannot_get_sender": `Cannot get sender current duel`, "errors.duel_cannot_set_user_cooldown": `Cannot set user cooldown: {reason}`, "info.user_already_in_duel": `Target user already in duel`, "errors.duel_cannot_check_cooldown": `Cannot check duel cooldown: {reason}`, "errors.seppuku_cannot_find_settings": `Cannot find seppuku settings`, "errors.duel_with_bot": `You cannot duel with bot`, "errors.voteban_cannot_find_user": `Cannot find target user`, "errors.duel_cannot_validate_participants": `Cannot validate participants`, "errors.voteban_cannot_check_progress": `Cannot check if vote in progress`, "errors.roulette_cannot_send_death_message": `Cannot send death message`, "errors.voteban_cannot_find_settings": `Cannot find voteban settings`, "errors.voteban_cannot_timeout_moderator": `Cannot start voteban on moderator`, "info.sender_already_in_duel": `You already in duel`, "info.voteban_in_progress": `Another voteban in progress`, "errors.duel_cannot_save_data": `Cannot save duel data: {reason}`, "errors.voteban_cannot_set_vote_expiration": `Cannot set vote expiration`, "info.user_not_participate": `You are not participate in any duel`, "errors.voteban_cannot_lock": `Cannot lock voteban`, "errors.duel_cannot_get_with_settings": `Cannot get duel channel settings`, "errors.duel_cannot_save_to_cache": `Cannot save duel data to cache`, "errors.duel_cannot_save_result": `Cannot save duel result: {reason}`, "errors.8ball_cannot_find": `Cannot find 8ball settings`}, "manage": map[string]string{"errors.alias_cannot_get_existed_commands": `Cannot get existed commands`, "errors.command_have_no_aliases": `Command have no aliases`, "errors.command_cannot_update": `Cannot update command`, "edit.command_edited": `✅ Command edited`, "errors.command_with_alias_already_exists": `Command with that name or alias already exists`, "errors.command_cannot_delete_default": `Cannot delete default command`, "errors.alias_already_exist": `Command with {alias} name or alias already exists`, "errors.command_large_size": `Command name cannot be greatest then 20.`, "remove.command_removed": `✅ Command removed`, "errors.command_cannot_save": `Cannot save command`, "errors.command_not_found": `Command not found`, "errors.command_with_name_cannot_find": `Command with that name not found`, "errors.command_cannot_get": `Cannot get command`, "errors.command_cannot_update_response": `Cannot update response because you have more than 1 response in command. Please use UI.`, "add.alias_add": `✅ Alias added`, "errors.alias_not_command": `That alias not in the command`, "errors.alias_cannot_update": `Cannot update command aliases`, "add.command_add": `✅ Command added`, "remove.alias_removed": `✅ Alias removed`}, "prefix": map[string]string{"errors.too_long": `Prefix cannot be longer than 10 characters`, "errors.cannot_get_current": `Cannot get current prefix`, "errors.cannot_create": `Cannot create prefix`, "errors.cannot_update": `Cannot update prefix`, "errors.required": `Prefix is required`, "success.updated": `Prefix updated`}, "quotes": map[string]string{"errors.not_found": `Quote not found`, "errors.empty_text": `Quote text cannot be empty`, "errors.cannot_get": `Cannot get quote`, "errors.cannot_add": `Cannot add quote`, "errors.cannot_remove": `Cannot remove quote`, "errors.random_empty": `No quotes have been added yet`, "add.added": `Quote added #{number}`, "remove.removed": `Quote removed`}, "shorturl": map[string]string{"errors.cannot_create_short_url": `Cannot create short url. {error}`, "success.short_url_created": `Short url: {url}`}, "categories_aliases": map[string]string{"errors.twitch_client_cannot_to_create": `Cannot create twitch client`, "errors.category_failed_to_get": `Failed to get caterogies`, "errors.category_cannot_to_get": `Cannot get categories`, "errors.game_cannot_to_get": `Cannot get games`, "errors.alias_already_exists": `Alias {aliasName} already exists`, "errors.alias_empty": `No categories aliases created`, "add.alias_add_to_category": `Category alias {aliasName} added with category {categoryName}`, "errors.alias_removed": `Category alias {aliasName} removed`, "errors.category_failed_to_create": `Failed to create category`, "errors.category_required": `Alias and category are required`, "errors.category_not_found": `Category not found`, "errors.category_cannot_delete": `Cannot delete category`, "errors.alias_not_found": `Category alias not found`}, "chat_wall": map[string]string{"hints.deletePhraseArgName": `Phrase to delete`, "hints.timeoutDurationArgName": `Time. Examples: 10m, 10, 1h5m`, "errors.invalid_duration": `Invalid duration. Cannot be longer 2w Examples: 10m, 10, 1h5m`, "errors.chat_wall_not_found": `Chat wall {errorPhrase} not found or already stopped`, "stop.chat_wal_stop": `✅ Chat wall {chatWallPhrase} stopped`, "hints.timeoutPhraseArgName": `Phrase to ban`, "hints.banPhraseArgName": `Phrase to ban`, "errors.long_duration_timeout": `Duration of timeout cannot be longer than 2 weeks`, "errors.duration_cannot_parse": `Cannot parse duration`, "start.chat_wall_start": `✅ Chat wall started for 10 minutes, you can stop it with !chat wall stop {chatWallPhrase}`}, "dudes": map[string]string{"errors.sprite_cannot_trigger": `Cannot trigger dudes sprite`, "info.color": `Your color is {dudeColor}`, "info.color_changed": `Color changed to {dudeColor}`, "errors.grow_cannot_trigger": `Cannot trigger dudes grow`, "errors.jump_cannot_trigger": `Cannot trigger dudes jump`, "errors.leave_cannot_trigger": `Cannot trigger dudes leave`, "errors.color_invalid": `Invalid color`, "info.sprite_changed": `Sprite changed to {dudeSprite}`, "info.sprite": `Your sprite is {dudeSprite}`, "info.color_required": `Color is required`, "info.sprite_required": `Sprite is required, available: {availableSprites}`, "info.color_reset": `Color reset to default`, "errors.sprite_invalid": `Invalid sprite, available: {availableSprites}`, "errors.color_cannot_trigger": `Cannot trigger dudes color`}, "subage": map[string]string{"responses.not_subscriber": `{user} is not a subscriber`, "responses.not_subscriber_but_was": `{user} is not a subscriber but was subscribed for {months} months`, "responses.subscription_info": `{user} is a {tier} subscriber of {channel} for {months} months`, "responses.streak_info": `(streak: {months} months)`, "errors.not_subscriber_or_hidden": `User is not a subscriber or their subscription info is hidden`, "responses.time_remaining": `(time remaining: {duration})`}, "vips": map[string]string{"errors.removed": `✅ Removed vip from {userName}`, "errors.added": `✅ Added vip to {userName}`, "errors.invalid_duration": `Invalid duration format. Please use formats like <1h>, <30m>, or <2d>`, "errors.cannot_create_scheduled_in_db": `Cannot create scheduled vip in database`, "errors.no_scheduled_vips": `There are no scheduled vips`, "errors.updated": `✅ Updated vip for user {userName} new expriation time {endTime}`, "errors.already_have_role": `User already vip or moderator!`, "errors.added_with_remove_time": `✅ Added vip to {userName}, will be removed at {endTime}`, "errors.cannot_get_list_from_db": `Cannot get vip list from database`, "errors.cannot_update": `Cannot update scheduled vip`, "hints.user": `@username`, "hints.unvip_in": `can be time in format: 1w1h30m, 2d5h; or can be stream_end to unvip when stream ends (delayed for 10 mins in case of stream crash). Leave it empty for permanent vip.`}, "clip": map[string]string{"cannot_get_clip": `Cannot get created clip`, "clip_created": `Clip created: {url}`, "cannot_create_clip": `Cannot create clip`, "empty_clip_url": `Clip URL is empty, please try again`}, "permit": map[string]string{"success.added_permit": `✅ Added {countPermit} permits to {userName}`, "errors.cannot_create": `Cannot create permit`}, "shoutout": map[string]string{"response_online": `Join https://twitch.tv/{userName} shining in 🎮 {categoryName} 📜 {title} with 👁️ {viewers} viewers!`, "response_offline": `Explore https://twitch.tv/{userName}’s world, last featured in 🎮 {categoryName} 📜 {title}!`, "errors.bot_have_no_permissions": `We have no permissions for shoutout. Streamer must re-authorize to bot dashboard.`}, "songrequest": map[string]string{"errors.remove_song_from_queue": `Cannot remove song from queue`, "errors.update_song": `Cannot update song`, "info.delete": `Song {songTitle} deleted from queue`, "validate.errors.internal_error": `Internal error when checking follow`, "errors.get_current_queue_count": `Cannot get current queue count`, "errors.search_song": `Cannot search song`, "errors.get_songs_from_queue": `Cannot get songs from queue`, "info.song_skipped": `Song {songTitle} skipped`, "info.no_requested_songs": `You haven't requested any song`, "validate.errors.need_follow": `For request song you need to be a followed`, "validate.errors.restrictions_on_user": `There are restrictions on user, but i cannot find you in db, sorry :(`, "errors.get_users_count": `Cannot get online users count`, "errors.get_current_song": `Cannot get current song`, "errors.get_latest_song": `Cannot get latest song`, "errors.get_current_vote": `Cannot get current vote`, "errors.get_votes_count": `Cannot get votes count`, "errors.not_found": `Current song not found`, "errors.get_settings": `Cannot get song requests settings`, "info.only_count_songs": `There is only {songsCount} songs`}, "tts": map[string]string{"errors.while_enable": `Error while enabling tts`, "info.change_pitch": `Pitch changed to {newPitch}`, "info.pitch": `Global pitch: {globalPitch} | Your pitch: {userPitch}`, "info.change_volume": `TTS volume changed to {userVolume}`, "info.change_rate": `Rate changed to {newRate}`, "errors.not_configured": `TTS is not configured for this channel`, "info.no_voices": `No voices available`, "info.disabled": `TTS disabled`, "errors.sending_to_tts": `Error while sending message to tts service`, "info.enabled": `TTS enabled`, "info.current_volume": `Current volume: {ttsVolume}`, "errors.while_getting_voices": `Error while getting voices`, "info.change_voice": `Voice changed to {newVoice}`, "info.voice": `Global voice: {globalVoice} | Your voice: {userVoice}`, "info.rate": `Global rate: {globalRate} | Your rate: {userRate}`, "info.voice_disallowed": `Voice {voiceName} is disallowed for usage`, "errors.while_disable": `Error while disabling tts`}, "7tv": map[string]string{"errors.emote_failed_to_rename": `Failed to rename 7tv emote: {reason}`, "errors.emote_not_found_in_channel": `❌ Emote {emoteSearch} not found in target channel`, "emote_info.response": `{name}: {link} · Added by @{addedByUserName} {addedByTime} ago · Author {emoteAuthor}`, "hints.emoteForCopyAlias": `Alias for emote`, "hints.emoteForAddArgLink": `Link or name`, "hints.emoteForAddArgAlias": `Optional alias`, "errors.emote_failed_to_add": `Failed to add 7tv emote: {reason}`, "errors.profile_not_found": `7tv profile not found`, "errors.emote_failed_to_fetch": `Failed to fetch 7tv emote: {reason}`, "errors.emote_not_found": `Emote {emoteName} not found.`, "errors.emoteset_not_active": `You don't have an active 7TV emote set`, "errors.emoteset_not_found": `Emote set {emoteName} not found`, "errors.emoteset_broadcaster_not_active": `❌ No active emote set for broadcaster`, "errors.emote_already_exist_in_channel": `❌ Emote {emoteName} already exists in this channel`, "add.emote_add": `✅ Emote added`, "remove.emote_remove": `✅ Emote {emoteName} removed`, "rename.emote_rename": `✅ Emote {oldEmoteName} renamed to {newEmoteName}"`, "profile_info.response": `{profileLink} · Paint: {paintName} ({unlockedPaints} unlocked) · Roles: {roles} · Editor for {editorCount} · Set: {emoteSetName} ({emoteSetCount}/{emoteSetCapacity}) · Created: {profileCreatedAt}`, "hints.copySetChannelName": `@channelName`, "errors.profile_failed_to_get": `Failed to get 7tv profile: {reason}`, "errors.emote_failed_to_remove": `Failed to remove 7tv emote: {reason}`, "errors.emote_not_found_in_emoteset": `Emote {emoteName} not found in set {emoteSet}`, "hints.emoteForCopyArgName": `Name of emote to copy`, "hints.copySetNameOfSet": `Name of set to copy`}, "dota": map[string]string{"errors.disabled": `Dota 2 is disabled for this channel.`, "errors.mmr_negative": `MMR cannot be negative.`, "errors.update_mmr": `Unable to update MMR right now.`, "medals.divine": `Divine`, "errors.get_settings": `Unable to read Dota 2 settings right now.`, "medals.archon": `Archon`, "medals.guardian": `Guardian`, "outputs.gm": `{medal}`, "outputs.loss": `Loss`, "errors.command_disabled": `This Dota 2 command is disabled.`, "errors.win_probability_unavailable": `Win probability is unavailable right now.`, "errors.get_data": `Unable to get Dota 2 data right now.`, "outputs.last_game": `Latest game: {hero}, {kda}, {result}, {duration}`, "success.mmr_updated": `MMR updated to {mmr}.`, "medals.crusader": `Crusader`, "outputs.notable_players": `{players}`, "outputs.win": `Win`, "errors.no_notable_players": `No notable players found in the active match.`, "errors.settings_not_found": `Dota 2 is not configured for this channel.`, "medals.immortal": `Immortal`, "outputs.mmr": `MMR: {mmr} ({medal})`, "outputs.wl": `{record} ({winRate})`, "errors.no_last_game": `No recent Dota 2 game is available.`, "medals.legend": `Legend`, "outputs.win_probability": `Win chance: {probability}`, "errors.mmr_required": `MMR is required.`, "errors.no_active_match": `No active Dota 2 match is available.`, "hints.mmr": `MMR`, "medals.ancient": `Ancient`, "medals.herald": `Herald`}}, "errors": map[string]map[string]string{"generic": map[string]string{"cannot_timeout_user": `Cannot timeout user`, "updating_settings": `Error while updating settings`, "cannot_get_moderators": `Cannot get moderators: {reason}`, "cannot_find_user_db": `Cannot find user in database`, "create_settings": `Error while creating settings`, "cannot_get_db_channel": `Cannot get database channel`, "cannot_get_stream": `Cannot get stream. {reason}`, "cannot_create_command": `Cannot create command`, "cannot_get_accept_command_name": `Cannot get accept command name`, "user_not_found": `User not found`, "broadcaster_client": `Cannot create broadcaster twitch client`, "cannot_get_user": `Cannot get user: {reason}`, "something_went_wrong": `Something went wrong, please try again later`, "internal": `❌ Internal error`, "cannot_create_twitch": `Cannot create twitch client`, "getting_user_settings": `Error while getting user settings`, "getting_channel_settings": `Error while getting channel settings`, "should_mention_with_at": `You should tag user with @`, "twir_error": `[Twir error]: Unknown error happened. Please contact developers.`, "cannot_find_channel_db": `Cannot find channel in database`, "cannot_find_users_twitch": `Cannot find users on twitch`, "not_a_follower": `Not a follower`, "cannot_find_channel_twitch": `Cannot find channel on twitch. {reason}`, "cannot_get_command": `Cannot get command`, "cannot_get_message": `Cannot get messages`, "cannot_ban_user": `Cannot ban user`, "cannot_find_user_twitch": `Cannot find user on twitch`}}, "services": map[string]map[string]string{"chat_wall": map[string]string{"errors.chat_wall_not_found": `Chat wall not found`, "errors.create_chat_wall_with_phrase": `Cannot create chat wall with phrase that already exists`, "errors.handled_messages_to_redis": `Cannot add handled messages to redis: {reason}`, "info.banned_by_twir": `Banned by twir for chat wall phrase: {banPhrase}`, "errors.get_chat_walls": `Cannot get chat walls: {reason}`, "errors.update_chat_walls": `Cannot update chat wall: {reason}`, "errors.get_chat_wall_settings": `Cannot get chat wall settings: {reason}`, "errors.publish_deleted_messages": `Cannot publish deleted messages: {reason}`, "errors.create_chat_logs_in_db": `Cannot create chat wall logs in db: {reason}`, "errors.get_users_stats": `Cannot get users stats: {reason}`, "errors.get_already_handled": `Cannot get already handled messages: {reason}`, "errors.create_chat_wall": `Cannot create chat wall: {reason}`, "errors.get_current_chat_walls": `Cannot get current chat walls: {reason}`, "errors.publish_ban_users": `Cannot publish ban users: {reason}`}, "shortenedurls": map[string]string{"errors.invalid_url": `Invalid url`}, "tts": map[string]string{"info.not_configured": `TTS not configured`, "info.no_voices": `No voices available`, "errors.not_found": `Voice {userVoice} not found`, "errors.voice_disallowed": `Voice {userVoice} is disallowed for usage`}}, "variables": map[string]map[string]string{"commands": map[string]string{"info.command_with_name_not_found": `Command with name {commandName} not found`, "info.get_count": `Cannot get count`, "info.no_passed_params": `Have not passed params to variable`}, "stream": map[string]string{"errors.error": `Error`, "errors.offline": `offline`, "errors.count_followers": `Cannot count followers`, "info.offline": `Offline or error on getting category`, "info.no_history": `No history recorded`, "errors.get_history_of_categories": `Cannot get history of categories`}, "user": map[string]string{"errors.find_user_on_twitch": `Cannot find user on twitch`}, "chat_eval": map[string]string{"info.wrong_code": `Probably you're doing some suspicious things or wrote wrong code.`}, "custom_var": map[string]string{"errors.update_custom_var": `Cannot update custom variables`, "errors.evaluate_variable": `Cannot evaluate variable. This is internal error, please report this bug`, "errors.wrong_numbers": `Wrong number: {reason}`}, "request": map[string]string{"errors.execute_request": `Cannot execute request`}, "subscribers": map[string]string{"errors.get_subscribers": `Cannot get subscribers`}, "7tv": map[string]string{"errors.no_roles": `No roles`, "errors.no_active_set": `You don't have a 7TV set set`, "errors.profile_not_found": `Failed to get 7tv profile: {reason}`, "errors.emote_not_found": `Emote {name} not found`, "errors.no_paint": `No paint`}, "countdown": map[string]string{"errors.not_passed_params": `Have not passed params to variable`, "errors.parse_date": `Cannot parse date`}, "followers": map[string]string{"errors.get_followers": `Cannot get followers`}, "keywords": map[string]string{"errors.not_found": `Keyword not found`, "errors.id_not_provided": `ID is not provided`}, "random": map[string]string{"errors.wrong_with_params": `Something is wrong with your params`, "errors.lower_numbers": `Numbers cannot be lower then 0`, "errors.empty_phrase": `Your phrases contains empty phrase, check you writed commas correctly`, "errors.parameters_not_specified": `Parameters are not specified`, "errors.wrong_number": `Wrong number of arguments passed to random`, "errors.first_larger_second": `First number cannot be larger then second`, "errors.parse_first_number": `Cannot parse first number from arguments`, "errors.get_online_user": `Cannot get online user`, "errors.parse_second_number": `Cannot parse second number from arguments`, "errors.not_passed_params": `Have not passed params to random variable`}, "shorturl": map[string]string{"errors.url_required": `URL is required`, "errors.create_short_url": `Cannot create short url: {reason}`}, "song": map[string]string{"errors.parse_played_at": `Cannot parse played at`, "info.history": `{trackTitle} - {trackArtist} (~{minutes}m ago)`, "info.no_needed_scope": `No needed scope, reconnect spotify in dashboard`, "info.no_integrations": `No integrations connected`, "info.get_spotify_integration": `Cannot get spotify integration: {reason}`, "info.failed_get_spotify_integration": `Failed to get spotify integration`, "info.get_spotify_entity": `Failed to get spotify entity`, "errors.get_recent_tracks": `Cannot get recent tracks: {reason}`, "errors.create_lastfm_service": `Cannot create lastfm service: {reason}`, "info.spotify_not_connected": `Spotify not connected`, "info.spotify_token_expired": `Spotify token expired, please reconnect Spotify in the dashboard`, "info.lastfm_integration": `LastFM integration not enabled`, "errors.fetch_tracks_lastfm": `Cannot fetch tracks from lastfm: {reason}`, "errors.fetch_tracks_spotify": `Cannot fetch tracks from spotify: {reason}`}, "valorant": map[string]string{"info.matches": `{matchResult}({roundsWon}/{roundsLost}) — {char} {KDA}`}}}}
