...
func (c *Greetings) GreetingsPut(ctx context.Context, request *greetings.PutRequest) (*greetings.Greeting, error) {
	//TODO implement me
	panic("implement me")
}

func (c *Greetings) GreetingsPatch(ctx context.Context, request *greetings.PatchRequest) (*greetings.Greeting, error) {
	//TODO implement me
	panic("implement me")
}
