<template>
  <footer class="bg-black-15 max-md:bg-black-10 min-md:px-6">
    <div class="container max-w-[1020px]">
      <div
        class="
          ...
          justify-between
          items-center
          min-md:border-b min-md:border-black-25
        "
      >
        <div
          class="
      ...
      <div class="text-xs text-gray-60 w-full text-center py-4">
