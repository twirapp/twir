	...
	for i, l := range m.Layers {
		layers[i] = customoverlayentity.ChannelOverlayLayer{
			...
			Settings: customoverlayentity.ChannelOverlayLayerSettings{
				...
				TextFontStyle:                      l.Settings.TextFontStyle,
				TextColor:                          l.Settings.TextColor,
				TextAlign:                          l.Settings.TextAlign,
				TextAlignVertical:                  l.Settings.TextAlignVertical,
				TextStrokeWidth:                    l.Settings.TextStrokeWidth,
				TextStrokeColor:                    l.Settings.TextStrokeColor,
				TextShadowColor:                    l.Settings.TextShadowColor,
				TextShadowBlur:                     l.Settings.TextShadowBlur,
				TextShadowOffsetX:                  l.Settings.TextShadowOffsetX,
				TextShadowOffsetY:                  l.Settings.TextShadowOffsetY,
				TextLineHeight:                     l.Settings.TextLineHeight,
				TextLetterSpacing:                  l.Settings.TextLetterSpacing,
				TextTransform:                      l.Settings.TextTransform,
