...
func WebhookNotificationsEntityToGql(
	...
	return gqlmodel.WebhookNotificationsSettings{
		...
		GithubIssuesOnline:        e.GithubIssuesOnlineEnabled,
		GithubIssuesOffline:       e.GithubIssuesOfflineEnabled,
		GithubPullRequestsOnline:  e.GithubPullRequestsOnlineEnabled,
		GithubPullRequestsOffline: e.GithubPullRequestsOfflineEnabled,
		GithubCommitsOnline:       e.GithubCommitsOnlineEnabled,
		GithubCommitsOffline:      e.GithubCommitsOfflineEnabled,
