...
func (h *Handler) addSecretTools(s *modelsdk.Server, requestScope scope) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "list_secrets", Description: "List secret metadata. Values are never included in list results."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, _ struct{}) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "get_secret", Description: "Get and decrypt one channel secret. Treat the returned value as sensitive."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "create_secret", Description: "Create an encrypted channel secret."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input createSecretInput) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "update_secret", Description: "Update an encrypted channel secret."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input updateSecretInput) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "delete_secret", Description: "Delete an encrypted channel secret."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
		if _, err := h.ownedSecret(ctx, requestScope, input.ID); err != nil {
			return nil, nil, err
		}
		id, _ := parseID(input.ID)
...
func (h *Handler) addStorageTools(s *modelsdk.Server, requestScope scope) {
	channelID := requestScope.Channel.ID.String()
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "list_storage_files", Description: "List channel JSON storage entries."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, _ struct{}) (*modelsdk.CallToolResult, any, error) {
		items, err := h.deps.Storage.GetAllByChannelID(ctx, channelID)
		return nil, map[string]any{"files": items}, err
	})
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "get_storage_file", Description: "Get a channel JSON storage entry by key."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input storageKeyInput) (*modelsdk.CallToolResult, any, error) {
		item, err := h.deps.Storage.GetByKey(ctx, channelID, input.Key)
		return nil, item, err
	})
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "upload_storage_file", Description: "Create or replace a channel JSON storage entry."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input setStorageInput) (*modelsdk.CallToolResult, any, error) {
		item, err := h.deps.Storage.Set(ctx, channelID, input.Key, input.Value)
		return nil, item, err
	})
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "delete_storage_file", Description: "Delete a channel JSON storage entry."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input storageKeyInput) (*modelsdk.CallToolResult, any, error) {
		err := h.deps.Storage.Delete(ctx, channelID, input.Key)
		return nil, map[string]bool{"deleted": err == nil}, err
	})
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "get_storage_usage", Description: "Get used and maximum channel storage bytes."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, _ struct{}) (*modelsdk.CallToolResult, any, error) {
...
func (h *Handler) addPastebinTools(s *modelsdk.Server, requestScope scope) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "list_pastes", Description: "List pastes owned by this channel owner."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input listInput) (*modelsdk.CallToolResult, any, error) {
		if input.Page < 1 {
			input.Page = 1
		}
		if input.PerPage < 1 {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "get_paste", Description: "Get an owned paste including its content."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
		item, err := h.ownedPaste(ctx, requestScope, input.ID)
		return nil, item, err
	})
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "get_paste_raw", Description: "Get raw content of an owned paste."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "create_paste", Description: "Create an owned paste."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input createPasteInput) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "update_paste", Description: "Update the content and expiration of an owned paste."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input updatePasteInput) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "delete_paste", Description: "Delete an owned paste."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
		if _, err := h.ownedPaste(ctx, requestScope, input.ID); err != nil {
			return nil, nil, err
		}
...
func (h *Handler) addShortURLTools(s *modelsdk.Server, requestScope scope) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "get_short_url", Description: "Get one owned short URL."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "delete_short_url", Description: "Delete an owned short URL."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
		if err := h.ownedShortURL(ctx, requestScope, input.ID); err != nil {
			return nil, nil, err
		}
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "get_short_url_stats", Description: "Get click statistics for an owned short URL."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input statsInput) (*modelsdk.CallToolResult, any, error) {
		if err := h.ownedShortURL(ctx, requestScope, input.ID); err != nil {
			return nil, nil, err
		}
		if input.Interval == "" {
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "list_banned_user_agents", Description: "List user-agent patterns banned for an owned short URL."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input idInput) (*modelsdk.CallToolResult, any, error) {
		if err := h.ownedShortURL(ctx, requestScope, input.ID); err != nil {
			return nil, nil, err
		}
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "ban_user_agent", Description: "Ban a user-agent pattern for an owned short URL."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input bannedUAInput) (*modelsdk.CallToolResult, any, error) {
		if err := h.ownedShortURL(ctx, requestScope, input.ID); err != nil {
			return nil, nil, err
		}
	...
	modelsdk.AddTool(s, &modelsdk.Tool{Name: "unban_user_agent", Description: "Remove a user-agent ban from an owned short URL."}, func(ctx context.Context, _ *modelsdk.CallToolRequest, input deleteBannedUAInput) (*modelsdk.CallToolResult, any, error) {
		if err := h.ownedShortURL(ctx, requestScope, input.ID); err != nil {
			return nil, nil, err
		}
